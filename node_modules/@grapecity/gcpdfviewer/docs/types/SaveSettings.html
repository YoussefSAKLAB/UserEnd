...
<li><a href="SaveSettings.html">SaveSettings</a></li></ul>
<h1>Type alias SaveSettings</h1></div>
<div class="tsd-signature">Save<wbr/>Settings<span class="tsd-signature-symbol">:</span> <span class="tsd-signature-symbol">{ </span>format<span class="tsd-signature-symbol">?: </span><span class="tsd-signature-type">&quot;PDF&quot;</span><span class="tsd-signature-symbol"> | </span><span class="tsd-signature-type">&quot;PNG&quot;</span><span class="tsd-signature-symbol">; </span>pages<span class="tsd-signature-symbol">?: </span><span class="tsd-signature-type">string</span><span class="tsd-signature-symbol">; </span>progressMessage<span class="tsd-signature-symbol">?: </span><span class="tsd-signature-type">string</span><span class="tsd-signature-symbol">; </span>progressTitle<span class="tsd-signature-symbol">?: </span><span class="tsd-signature-type">string</span><span class="tsd-signature-symbol">; </span>reload<span class="tsd-signature-symbol">?: </span><span class="tsd-signature-type">boolean</span><span class="tsd-signature-symbol">; </span>saveMode<span class="tsd-signature-symbol">?: </span><span class="tsd-signature-type">&quot;Auto&quot;</span><span class="tsd-signature-symbol"> | </span><span class="tsd-signature-type">&quot;Default&quot;</span><span class="tsd-signature-symbol"> | </span><span class="tsd-signature-type">&quot;Linearized&quot;</span><span class="tsd-signature-symbol"> | </span><span class="tsd-signature-type">&quot;IncrementalUpdate&quot;</span><span class="tsd-signature-symbol">; </span>sign<span class="tsd-signature-symbol">?: </span><a href="SignatureInfo.html" class="tsd-signature-type" data-tsd-kind="Type alias">SignatureInfo</a><span class="tsd-signature-symbol">; </span>zoomFactor<span class="tsd-signature-symbol">?: </span><span class="tsd-signature-type">number</span><span class="tsd-signature-symbol"> }</span></div>
...
<h5><code class="tsd-tag ts-flagOptional">Optional</code> format<span class="tsd-signature-symbol">?: </span><span class="tsd-signature-type">&quot;PDF&quot;</span><span class="tsd-signature-symbol"> | </span><span class="tsd-signature-type">&quot;PNG&quot;</span></h5>
<div class="tsd-comment tsd-typography"><p>Destination document format.
PDF - the document will be saved in PDF format.
PNG - the document will be saved to images.</p>

<h3>Default</h3><p>PDF.</p>
</div></li>
<li class="tsd-parameter">
<h5><code class="tsd-tag ts-flagOptional">Optional</code> pages<span class="tsd-signature-symbol">?: </span><span class="tsd-signature-type">string</span></h5>
<div class="tsd-comment tsd-typography"><p>You can specify the index of the page(s) or pages range to save.
...
or rotate page(s): await viewer.save(&quot;test_part10.pdf&quot;, { reload: true, pages: &quot;[angle:90]2-3&quot; });</p>

<h3>Example</h3><pre><code class="language-javascript"><span class="hl-5">// Save six pages with indices: 0, 1, 2, 3, 7, 9:</span><br/><span class="hl-7">await</span><span class="hl-1"> </span><span class="hl-2">viewer</span><span class="hl-1">.</span><span class="hl-3">save</span><span class="hl-1">(</span><span class="hl-4">&quot;test_part10.pdf&quot;</span><span class="hl-1">, { </span><span class="hl-2">reload:</span><span class="hl-1"> </span><span class="hl-0">true</span><span class="hl-1">, </span><span class="hl-2">pages:</span><span class="hl-1"> </span><span class="hl-4">&quot;0-3, 7, 9&quot;</span><span class="hl-1"> });</span>
</code></pre>

<h3>Example</h3><pre><code class="language-javascript"><span class="hl-5">// Rotate 90 degrees and save 2 pages with indices 2 and 3:</span><br/><span class="hl-7">await</span><span class="hl-1"> </span><span class="hl-2">viewer</span><span class="hl-1">.</span><span class="hl-3">save</span><span class="hl-1">(</span><span class="hl-4">&quot;test_part10.pdf&quot;</span><span class="hl-1">, { </span><span class="hl-2">reload:</span><span class="hl-1"> </span><span class="hl-0">true</span><span class="hl-1">, </span><span class="hl-2">pages:</span><span class="hl-1"> </span><span class="hl-4">&quot;[angle:90]2-3&quot;</span><span class="hl-1"> });</span>
</code></pre>

<h3>Example</h3><pre><code class="language-javascript"><span class="hl-5">// Invoke the system file picker dialog </span><br/><span class="hl-5">// to select an external PDF file to merge.</span><br/><span class="hl-5">// Then, merge first page from selected PDF document and</span><br/><span class="hl-5">// download result PDF file to local system.</span><br/><span class="hl-0">var</span><span class="hl-1"> </span><span class="hl-2">fileInput</span><span class="hl-1"> = </span><span class="hl-2">document</span><span class="hl-1">.</span><span class="hl-3">createElement</span><span class="hl-1">(</span><span class="hl-4">&#39;input&#39;</span><span class="hl-1">);</span><br/><span class="hl-2">fileInput</span><span class="hl-1">.</span><span class="hl-2">type</span><span class="hl-1"> = </span><span class="hl-4">&#39;file&#39;</span><span class="hl-1">;</span><br/><span class="hl-2">fileInput</span><span class="hl-1">.</span><span class="hl-2">accept</span><span class="hl-1"> = </span><span class="hl-4">&quot;.pdf&quot;</span><span class="hl-1">;</span><br/><span class="hl-2">fileInput</span><span class="hl-1">.</span><span class="hl-2">style</span><span class="hl-1">.</span><span class="hl-2">display</span><span class="hl-1"> = </span><span class="hl-4">&#39;none&#39;</span><span class="hl-1">;</span><br/><span class="hl-2">fileInput</span><span class="hl-1">.</span><span class="hl-3">onchange</span><span class="hl-1"> = </span><span class="hl-0">function</span><span class="hl-1"> () { </span><br/><span class="hl-1">    </span><span class="hl-7">if</span><span class="hl-1"> (</span><span class="hl-2">fileInput</span><span class="hl-1">.</span><span class="hl-2">files</span><span class="hl-1"> &amp;&amp; </span><span class="hl-2">fileInput</span><span class="hl-1">.</span><span class="hl-2">files</span><span class="hl-1">[</span><span class="hl-8">0</span><span class="hl-1">]) {</span><br/><span class="hl-1">        </span><span class="hl-0">var</span><span class="hl-1"> </span><span class="hl-2">fileReader</span><span class="hl-1"> = </span><span class="hl-0">new</span><span class="hl-1"> </span><span class="hl-3">FileReader</span><span class="hl-1">();</span><br/><span class="hl-1">        </span><span class="hl-2">fileReader</span><span class="hl-1">.</span><span class="hl-3">onload</span><span class="hl-1"> = </span><span class="hl-0">function</span><span class="hl-1"> () {</span><br/><span class="hl-1">            </span><span class="hl-0">const</span><span class="hl-1"> </span><span class="hl-6">fileId</span><span class="hl-1"> = </span><span class="hl-4">&quot;uniquefileid_&quot;</span><span class="hl-1"> + </span><span class="hl-0">new</span><span class="hl-1"> </span><span class="hl-9">Date</span><span class="hl-1">().</span><span class="hl-3">getTime</span><span class="hl-1">();</span><br/><span class="hl-1">            </span><span class="hl-2">viewer</span><span class="hl-1">.</span><span class="hl-2">storage</span><span class="hl-1">.</span><span class="hl-3">setItem</span><span class="hl-1">(</span><span class="hl-2">fileId</span><span class="hl-1">, </span><span class="hl-0">new</span><span class="hl-1"> </span><span class="hl-9">Uint8Array</span><span class="hl-1">(</span><span class="hl-2">fileReader</span><span class="hl-1">.</span><span class="hl-2">result</span><span class="hl-1">));</span><br/><span class="hl-1">            </span><span class="hl-5">// Merge first page from external PDF document </span><br/><span class="hl-1">            </span><span class="hl-5">// to the end of the active PDF document</span><br/><span class="hl-1">            </span><span class="hl-5">// and download result PDF file:</span><br/><span class="hl-1">            </span><span class="hl-7">await</span><span class="hl-1"> </span><span class="hl-2">viewer</span><span class="hl-1">.</span><span class="hl-3">save</span><span class="hl-1">(</span><span class="hl-4">&quot;sample.pdf&quot;</span><span class="hl-1">, </span><br/><span class="hl-1">                { </span><span class="hl-2">pages:</span><span class="hl-1"> </span><span class="hl-4">`0-</span><span class="hl-0">${</span><span class="hl-2">viewer</span><span class="hl-10">.</span><span class="hl-2">pageCount</span><span class="hl-10"> </span><span class="hl-1">-</span><span class="hl-10"> </span><span class="hl-8">1</span><span class="hl-0">}</span><span class="hl-4">, [file:</span><span class="hl-0">${</span><span class="hl-2">fileId</span><span class="hl-0">}</span><span class="hl-4">]0`</span><span class="hl-1">  });</span><br/><span class="hl-1">        };</span><br/><span class="hl-1">        </span><span class="hl-2">fileReader</span><span class="hl-1">.</span><span class="hl-3">readAsArrayBuffer</span><span class="hl-1">(</span><span class="hl-2">fileInput</span><span class="hl-1">.</span><span class="hl-2">files</span><span class="hl-1">[</span><span class="hl-8">0</span><span class="hl-1">]);</span><br/><span class="hl-1">    }</span><br/><span class="hl-1">};</span><br/><span class="hl-2">document</span><span class="hl-1">.</span><span class="hl-2">body</span><span class="hl-1">.</span><span class="hl-3">appendChild</span><span class="hl-1">(</span><span class="hl-2">fileInput</span><span class="hl-1">);</span><br/><span class="hl-2">fileInput</span><span class="hl-1">.</span><span class="hl-3">click</span><span class="hl-1">();</span>
</code></pre>
</div></li>
<li class="tsd-parameter">
<h5><code class="tsd-tag ts-flagOptional">Optional</code> progress<wbr/>Message<span class="tsd-signature-symbol">?: </span><span class="tsd-signature-type">string</span></h5>
<div class="tsd-comment tsd-typography"><p>Custom progress message to be displayed during save.</p>
<pre><code class="language-javascript"><span class="hl-2">viewer</span><span class="hl-1">.</span><span class="hl-3">save</span><span class="hl-1">(</span><span class="hl-4">&quot;sample.pdf&quot;</span><span class="hl-1">, { </span><span class="hl-2">pages:</span><span class="hl-1"> </span><span class="hl-4">&quot;[angle:90]0,1-5&quot;</span><span class="hl-1">, </span><span class="hl-2">progressMessage:</span><span class="hl-1"> </span><span class="hl-4">&quot;Rotating first page...&quot;</span><span class="hl-1"> }, </span><span class="hl-2">reload</span><span class="hl-1">: </span><span class="hl-0">true</span><span class="hl-1">);</span>
</code></pre>
</div></li>
<li class="tsd-parameter">
<h5><code class="tsd-tag ts-flagOptional">Optional</code> progress<wbr/>Title<span class="tsd-signature-symbol">?: </span><span class="tsd-signature-type">string</span></h5>
<div class="tsd-comment tsd-typography"><p>Custom progress title to be displayed during save.</p>
<pre><code class="language-javascript"><span class="hl-2">viewer</span><span class="hl-1">.</span><span class="hl-3">save</span><span class="hl-1">(</span><span class="hl-4">&quot;sample.pdf&quot;</span><span class="hl-1">, { </span><span class="hl-2">pages:</span><span class="hl-1"> </span><span class="hl-4">&quot;[angle:90]0,1-5&quot;</span><span class="hl-1">, </span><span class="hl-2">progressTitle:</span><span class="hl-1"> </span><span class="hl-4">&quot;Rotating&quot;</span><span class="hl-1"> }, </span><span class="hl-2">reload</span><span class="hl-1">: </span><span class="hl-0">true</span><span class="hl-1">);</span>
</code></pre>
</div></li>
<li class="tsd-parameter">
<h5><code class="tsd-tag ts-flagOptional">Optional</code> reload<span class="tsd-signature-symbol">?: </span><span class="tsd-signature-type">boolean</span></h5>
<div class="tsd-comment tsd-typography"><p>Load the updated PDF document into the viewer without downloading it to the local system.</p>

<h3>Example0</h3><pre><code class="language-javascript"><span class="hl-5">// Save dodument and load saved document into the viewer:</span><br/><span class="hl-7">await</span><span class="hl-1"> </span><span class="hl-2">viewer</span><span class="hl-1">.</span><span class="hl-3">save</span><span class="hl-1">(</span><span class="hl-4">&quot;test_part10.pdf&quot;</span><span class="hl-1">, { </span><span class="hl-2">reload:</span><span class="hl-1"> </span><span class="hl-0">true</span><span class="hl-1"> });</span>
</code></pre>
</div></li>
<li class="tsd-parameter">
<h5><code class="tsd-tag ts-flagOptional">Optional</code> save<wbr/>Mode<span class="tsd-signature-symbol">?: </span><span class="tsd-signature-type">&quot;Auto&quot;</span><span class="tsd-signature-symbol"> | </span><span class="tsd-signature-type">&quot;Default&quot;</span><span class="tsd-signature-symbol"> | </span><span class="tsd-signature-type">&quot;Linearized&quot;</span><span class="tsd-signature-symbol"> | </span><span class="tsd-signature-type">&quot;IncrementalUpdate&quot;</span></h5>
<div class="tsd-comment tsd-typography"><p>Defines the mode of saving a PDF.</p>

<h3>Default</h3><p>Auto the PDF is not linearized and the incremental update will be used only for signed PDF documents.</p>
</div></li>
<li class="tsd-parameter">
<h5><code class="tsd-tag ts-flagOptional">Optional</code> sign<span class="tsd-signature-symbol">?: </span><a href="SignatureInfo.html" class="tsd-signature-type" data-tsd-kind="Type alias">SignatureInfo</a></h5>
<div class="tsd-comment tsd-typography"><p>Signature settings used to save document with signature.
If specified, the document will be saved with signature.</p>
</div></li>
<li class="tsd-parameter">
<h5><code class="tsd-tag ts-flagOptional">Optional</code> zoom<wbr/>Factor<span class="tsd-signature-symbol">?: </span><span class="tsd-signature-type">number</span></h5>
<div class="tsd-comment tsd-typography"><p>Zoom factor to be used for rendering images when the target format is &quot;PNG&quot;.</p>
<pre><code class="language-javascript"><span class="hl-2">viewer</span><span class="hl-1">.</span><span class="hl-3">save</span><span class="hl-1">(</span><span class="hl-4">&quot;sample.pdf&quot;</span><span class="hl-1">, { </span><span class="hl-2">format:</span><span class="hl-1"> </span><span class="hl-4">&quot;PNG&quot;</span><span class="hl-1">, </span><span class="hl-2">zoomFactor:</span><span class="hl-1"> </span><span class="hl-8">1.5</span><span class="hl-1"> });</span>
</code></pre>
</div></li></ul></div></div>
...
<li class="current tsd-kind-type-alias"><a href="SaveSettings.html" class="tsd-index-link"><svg class="tsd-kind-icon" width="24" height="24" viewBox="0 0 24 24"><use href="#icon-4194304-path"></use><use href="#icon-4194304-text"></use></svg>Save<wbr/>Settings</a></li>
