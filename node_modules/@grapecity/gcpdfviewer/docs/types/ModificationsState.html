<!DOCTYPE html><html class="default" lang="en"><head><meta charSet="utf-8"/><meta http-equiv="x-ua-compatible" content="IE=edge"/><title>ModificationsState | Document Solutions PDF Viewer - v7.0.3</title><meta name="description" content="Documentation for Document Solutions PDF Viewer - v7.0.3"/><meta name="viewport" content="width=device-width, initial-scale=1"/><link rel="stylesheet" href="../assets/style.css"/><link rel="stylesheet" href="../assets/highlight.css"/><link rel="stylesheet" href="../assets/custom.css"/><script async src="../assets/search.js" id="search-script"></script></head><body><script>document.documentElement.dataset.theme = localStorage.getItem("tsd-theme") || "os"</script><header class="tsd-page-toolbar">
...
<li><a href="ModificationsState.html">ModificationsState</a></li></ul>
<h1>Type alias ModificationsState</h1></div>
<div class="tsd-signature">Modifications<wbr/>State<span class="tsd-signature-symbol">:</span> <span class="tsd-signature-symbol">{ </span>lastChangeType<span class="tsd-signature-symbol">: </span><a href="../enums/ModificationType.html" class="tsd-signature-type" data-tsd-kind="Enumeration">ModificationType</a><span class="tsd-signature-symbol">; </span>newAnnotations<span class="tsd-signature-symbol">: </span><span class="tsd-signature-symbol">{ </span>annotation<span class="tsd-signature-symbol">: </span><a href="../classes/AnnotationBase.html" class="tsd-signature-type" data-tsd-kind="Class">AnnotationBase</a><span class="tsd-signature-symbol">; </span>pageIndex<span class="tsd-signature-symbol">: </span><span class="tsd-signature-type">number</span><span class="tsd-signature-symbol"> }</span><span class="tsd-signature-symbol">[]</span><span class="tsd-signature-symbol">; </span>removedAnnotations<span class="tsd-signature-symbol">: </span><span class="tsd-signature-symbol">{ </span>annotationId<span class="tsd-signature-symbol">: </span><span class="tsd-signature-type">string</span><span class="tsd-signature-symbol">; </span>pageIndex<span class="tsd-signature-symbol">: </span><span class="tsd-signature-type">number</span><span class="tsd-signature-symbol"> }</span><span class="tsd-signature-symbol">[]</span><span class="tsd-signature-symbol">; </span>structure<span class="tsd-signature-symbol">?: </span><a href="StructureChanges.html" class="tsd-signature-type" data-tsd-kind="Type alias">StructureChanges</a><span class="tsd-signature-symbol">; </span>undoCount<span class="tsd-signature-symbol">: </span><span class="tsd-signature-type">number</span><span class="tsd-signature-symbol">; </span>undoIndex<span class="tsd-signature-symbol">: </span><span class="tsd-signature-type">number</span><span class="tsd-signature-symbol">; </span>updatedAnnotations<span class="tsd-signature-symbol">: </span><span class="tsd-signature-symbol">{ </span>annotation<span class="tsd-signature-symbol">: </span><a href="../classes/AnnotationBase.html" class="tsd-signature-type" data-tsd-kind="Class">AnnotationBase</a><span class="tsd-signature-symbol">; </span>pageIndex<span class="tsd-signature-symbol">: </span><span class="tsd-signature-type">number</span><span class="tsd-signature-symbol"> }</span><span class="tsd-signature-symbol">[]</span><span class="tsd-signature-symbol">; </span>version<span class="tsd-signature-symbol">: </span><span class="tsd-signature-type">number</span><span class="tsd-signature-symbol"> }</span></div>
<div class="tsd-comment tsd-typography"><p>Shared document modifications.</p>
</div>
<div class="tsd-type-declaration">
<h4>Type declaration</h4>
<ul class="tsd-parameters">
<li class="tsd-parameter">
<h5>last<wbr/>Change<wbr/>Type<span class="tsd-signature-symbol">: </span><a href="../enums/ModificationType.html" class="tsd-signature-type" data-tsd-kind="Enumeration">ModificationType</a></h5></li>
<li class="tsd-parameter">
<h5>new<wbr/>Annotations<span class="tsd-signature-symbol">: </span><span class="tsd-signature-symbol">{ </span>annotation<span class="tsd-signature-symbol">: </span><a href="../classes/AnnotationBase.html" class="tsd-signature-type" data-tsd-kind="Class">AnnotationBase</a><span class="tsd-signature-symbol">; </span>pageIndex<span class="tsd-signature-symbol">: </span><span class="tsd-signature-type">number</span><span class="tsd-signature-symbol"> }</span><span class="tsd-signature-symbol">[]</span></h5></li>
<li class="tsd-parameter">
<h5>removed<wbr/>Annotations<span class="tsd-signature-symbol">: </span><span class="tsd-signature-symbol">{ </span>annotationId<span class="tsd-signature-symbol">: </span><span class="tsd-signature-type">string</span><span class="tsd-signature-symbol">; </span>pageIndex<span class="tsd-signature-symbol">: </span><span class="tsd-signature-type">number</span><span class="tsd-signature-symbol"> }</span><span class="tsd-signature-symbol">[]</span></h5></li>
<li class="tsd-parameter">
<h5><code class="tsd-tag ts-flagOptional">Optional</code> structure<span class="tsd-signature-symbol">?: </span><a href="StructureChanges.html" class="tsd-signature-type" data-tsd-kind="Type alias">StructureChanges</a></h5></li>
<li class="tsd-parameter">
<h5>undo<wbr/>Count<span class="tsd-signature-symbol">: </span><span class="tsd-signature-type">number</span></h5></li>
<li class="tsd-parameter">
<h5>undo<wbr/>Index<span class="tsd-signature-symbol">: </span><span class="tsd-signature-type">number</span></h5></li>
<li class="tsd-parameter">
<h5>updated<wbr/>Annotations<span class="tsd-signature-symbol">: </span><span class="tsd-signature-symbol">{ </span>annotation<span class="tsd-signature-symbol">: </span><a href="../classes/AnnotationBase.html" class="tsd-signature-type" data-tsd-kind="Class">AnnotationBase</a><span class="tsd-signature-symbol">; </span>pageIndex<span class="tsd-signature-symbol">: </span><span class="tsd-signature-type">number</span><span class="tsd-signature-symbol"> }</span><span class="tsd-signature-symbol">[]</span></h5></li>
<li class="tsd-parameter">
<h5>version<span class="tsd-signature-symbol">: </span><span class="tsd-signature-type">number</span></h5></li></ul></div></div>
...
<li class="current tsd-kind-type-alias"><a href="ModificationsState.html" class="tsd-index-link"><svg class="tsd-kind-icon" width="24" height="24" viewBox="0 0 24 24"><use href="#icon-4194304-path"></use><use href="#icon-4194304-text"></use></svg>Modifications<wbr/>State</a></li>
