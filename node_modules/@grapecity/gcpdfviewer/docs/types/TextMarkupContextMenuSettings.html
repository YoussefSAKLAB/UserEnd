<!DOCTYPE html><html class="default" lang="en"><head><meta charSet="utf-8"/><meta http-equiv="x-ua-compatible" content="IE=edge"/><title>TextMarkupContextMenuSettings | Document Solutions PDF Viewer - v7.0.3</title><meta name="description" content="Documentation for Document Solutions PDF Viewer - v7.0.3"/><meta name="viewport" content="width=device-width, initial-scale=1"/><link rel="stylesheet" href="../assets/style.css"/><link rel="stylesheet" href="../assets/highlight.css"/><link rel="stylesheet" href="../assets/custom.css"/><script async src="../assets/search.js" id="search-script"></script></head><body><script>document.documentElement.dataset.theme = localStorage.getItem("tsd-theme") || "os"</script><header class="tsd-page-toolbar">
...
<li><a href="TextMarkupContextMenuSettings.html">TextMarkupContextMenuSettings</a></li></ul>
<h1>Type alias TextMarkupContextMenuSettings</h1></div>
<div class="tsd-signature">Text<wbr/>Markup<wbr/>Context<wbr/>Menu<wbr/>Settings<span class="tsd-signature-symbol">:</span> <span class="tsd-signature-symbol">{ </span>colors<span class="tsd-signature-symbol">: </span><span class="tsd-signature-symbol">{ </span>displayName<span class="tsd-signature-symbol">: </span><span class="tsd-signature-type">string</span><span class="tsd-signature-symbol">; </span>value<span class="tsd-signature-symbol">: </span><span class="tsd-signature-type">string</span><span class="tsd-signature-symbol"> }</span><span class="tsd-signature-symbol">[]</span><span class="tsd-signature-symbol"> }</span></div>
<div class="tsd-comment tsd-typography"><p>Text markup context menu settings</p>
</div>
<div class="tsd-type-declaration">
<h4>Type declaration</h4>
<ul class="tsd-parameters">
<li class="tsd-parameter">
<h5>colors<span class="tsd-signature-symbol">: </span><span class="tsd-signature-symbol">{ </span>displayName<span class="tsd-signature-symbol">: </span><span class="tsd-signature-type">string</span><span class="tsd-signature-symbol">; </span>value<span class="tsd-signature-symbol">: </span><span class="tsd-signature-type">string</span><span class="tsd-signature-symbol"> }</span><span class="tsd-signature-symbol">[]</span></h5>
<div class="tsd-comment tsd-typography"><p>Available colors</p>

<h3>Example</h3><pre><code class="language-javascript"><span class="hl-5">// Change available colors:</span><br/><span class="hl-14">textMarkupContextMenu</span><span class="hl-1">: { </span><span class="hl-14">colors</span><span class="hl-1">: [{</span><span class="hl-2">value:</span><span class="hl-1"> </span><span class="hl-4">&quot;#ff0000&quot;</span><span class="hl-1">, </span><span class="hl-2">displayName:</span><span class="hl-1"> </span><span class="hl-4">&quot;Red&quot;</span><span class="hl-1">}, {</span><span class="hl-2">value:</span><span class="hl-1"> </span><span class="hl-4">&quot;#000000&quot;</span><span class="hl-1">, </span><span class="hl-2">displayName:</span><span class="hl-1"> </span><span class="hl-4">&quot;Black&quot;</span><span class="hl-1">}] }</span>
</code></pre>
<pre><code class="language-javascript"><span class="hl-5">// Hide colors groups:</span><br/><span class="hl-14">textMarkupContextMenu</span><span class="hl-1">: { </span><span class="hl-14">colors</span><span class="hl-1">: [] }</span>
</code></pre>
</div></li></ul></div></div>
...
<li class="current tsd-kind-type-alias"><a href="TextMarkupContextMenuSettings.html" class="tsd-index-link"><svg class="tsd-kind-icon" width="24" height="24" viewBox="0 0 24 24"><use href="#icon-4194304-path"></use><use href="#icon-4194304-text"></use></svg>Text<wbr/>Markup<wbr/>Context<wbr/>Menu<wbr/>Settings</a></li>
