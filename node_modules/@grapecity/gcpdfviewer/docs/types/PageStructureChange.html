...
<li><a href="PageStructureChange.html">PageStructureChange</a></li></ul>
<h1>Type alias PageStructureChange</h1></div>
<div class="tsd-signature">Page<wbr/>Structure<wbr/>Change<span class="tsd-signature-symbol">:</span> <span class="tsd-signature-symbol">{ </span>add<span class="tsd-signature-symbol">: </span><span class="tsd-signature-type">boolean</span><span class="tsd-signature-symbol">; </span>checkNumPages<span class="tsd-signature-symbol">: </span><span class="tsd-signature-type">number</span><span class="tsd-signature-symbol">; </span>mod<span class="tsd-signature-symbol">?: </span><a href="PageModification.html" class="tsd-signature-type" data-tsd-kind="Type alias">PageModification</a><span class="tsd-signature-symbol">; </span>modOnly<span class="tsd-signature-symbol">?: </span><span class="tsd-signature-type">boolean</span><span class="tsd-signature-symbol">; </span>pageIndex<span class="tsd-signature-symbol">: </span><span class="tsd-signature-type">number</span><span class="tsd-signature-symbol"> }</span></div>
<div class="tsd-comment tsd-typography"><p>Page structure change.</p>
</div>
<div class="tsd-type-declaration">
<h4>Type declaration</h4>
<ul class="tsd-parameters">
<li class="tsd-parameter">
<h5>add<span class="tsd-signature-symbol">: </span><span class="tsd-signature-type">boolean</span></h5></li>
<li class="tsd-parameter">
<h5>check<wbr/>Num<wbr/>Pages<span class="tsd-signature-symbol">: </span><span class="tsd-signature-type">number</span></h5></li>
<li class="tsd-parameter">
<h5><code class="tsd-tag ts-flagOptional">Optional</code> mod<span class="tsd-signature-symbol">?: </span><a href="PageModification.html" class="tsd-signature-type" data-tsd-kind="Type alias">PageModification</a></h5></li>
<li class="tsd-parameter">
<h5><code class="tsd-tag ts-flagOptional">Optional</code> mod<wbr/>Only<span class="tsd-signature-symbol">?: </span><span class="tsd-signature-type">boolean</span></h5></li>
<li class="tsd-parameter">
<h5>page<wbr/>Index<span class="tsd-signature-symbol">: </span><span class="tsd-signature-type">number</span></h5></li></ul></div></div>
...
<li class="current tsd-kind-type-alias"><a href="PageStructureChange.html" class="tsd-index-link"><svg class="tsd-kind-icon" width="24" height="24" viewBox="0 0 24 24"><use href="#icon-4194304-path"></use><use href="#icon-4194304-text"></use></svg>Page<wbr/>Structure<wbr/>Change</a></li>
