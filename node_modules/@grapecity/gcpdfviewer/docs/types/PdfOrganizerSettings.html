...
<li><a href="PdfOrganizerSettings.html">PdfOrganizerSettings</a></li></ul>
<h1>Type alias PdfOrganizerSettings</h1></div>
<div class="tsd-signature">Pdf<wbr/>Organizer<wbr/>Settings<span class="tsd-signature-symbol">:</span> <span class="tsd-signature-symbol">{ </span>layout<span class="tsd-signature-symbol">?: </span><span class="tsd-signature-type">&quot;Auto&quot;</span><span class="tsd-signature-symbol"> | </span><span class="tsd-signature-type">&quot;OneColumn&quot;</span><span class="tsd-signature-symbol"> | </span><span class="tsd-signature-type">&quot;TwoColumns&quot;</span><span class="tsd-signature-symbol">; </span>title<span class="tsd-signature-symbol">?: </span><span class="tsd-signature-type">string</span><span class="tsd-signature-symbol"> }</span></div>
<div class="tsd-comment tsd-typography"><p>PDF Organizer dialog settings.</p>
</div>
...
<div class="tsd-comment tsd-typography"><p>PDF Organizer dialog layout type.</p>
...
<h3>Default</h3><p>&#39;PDF Organizer&#39;</p>

<h3>Example</h3><pre><code class="language-javascript"><span class="hl-1">      </span><span class="hl-2">options</span><span class="hl-1">.</span><span class="hl-2">pdfOrganizer</span><span class="hl-1"> = {</span><br/><span class="hl-1">            </span><span class="hl-2">title:</span><span class="hl-1"> </span><span class="hl-4">&#39;PDF document structure&#39;</span><br/><span class="hl-1">      };</span>
</code></pre>
</div></li></ul></div></div>
...
<li class="current tsd-kind-type-alias"><a href="PdfOrganizerSettings.html" class="tsd-index-link"><svg class="tsd-kind-icon" width="24" height="24" viewBox="0 0 24 24"><use href="#icon-4194304-path"></use><use href="#icon-4194304-text"></use></svg>Pdf<wbr/>Organizer<wbr/>Settings</a></li>
