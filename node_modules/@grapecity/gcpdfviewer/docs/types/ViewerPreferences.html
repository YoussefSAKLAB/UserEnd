<!DOCTYPE html><html class="default" lang="en"><head><meta charSet="utf-8"/><meta http-equiv="x-ua-compatible" content="IE=edge"/><title>ViewerPreferences | Document Solutions PDF Viewer - v7.0.3</title><meta name="description" content="Documentation for Document Solutions PDF Viewer - v7.0.3"/><meta name="viewport" content="width=device-width, initial-scale=1"/><link rel="stylesheet" href="../assets/style.css"/><link rel="stylesheet" href="../assets/highlight.css"/><link rel="stylesheet" href="../assets/custom.css"/><script async src="../assets/search.js" id="search-script"></script></head><body><script>document.documentElement.dataset.theme = localStorage.getItem("tsd-theme") || "os"</script><header class="tsd-page-toolbar">
...
<li><a href="ViewerPreferences.html">ViewerPreferences</a></li></ul>
<h1>Type alias ViewerPreferences</h1></div>
<div class="tsd-signature">Viewer<wbr/>Preferences<span class="tsd-signature-symbol">:</span> <span class="tsd-signature-symbol">{ </span>centerWindow<span class="tsd-signature-symbol">?: </span><span class="tsd-signature-type">boolean</span><span class="tsd-signature-symbol">; </span>displayDocTitle<span class="tsd-signature-symbol">?: </span><span class="tsd-signature-type">boolean</span><span class="tsd-signature-symbol">; </span>fitWindow<span class="tsd-signature-symbol">?: </span><span class="tsd-signature-type">boolean</span><span class="tsd-signature-symbol">; </span>hideMenubar<span class="tsd-signature-symbol">?: </span><span class="tsd-signature-type">boolean</span><span class="tsd-signature-symbol">; </span>hideToolbar<span class="tsd-signature-symbol">?: </span><span class="tsd-signature-type">boolean</span><span class="tsd-signature-symbol">; </span>hideWindowUI<span class="tsd-signature-symbol">?: </span><span class="tsd-signature-type">boolean</span><span class="tsd-signature-symbol">; </span>nonFullScreenPageMode<span class="tsd-signature-symbol">?: </span><a href="PageMode.html" class="tsd-signature-type" data-tsd-kind="Type alias">PageMode</a><span class="tsd-signature-symbol">; </span>openAction<span class="tsd-signature-symbol">?: </span><a href="OpenAction.html" class="tsd-signature-type" data-tsd-kind="Type alias">OpenAction</a><span class="tsd-signature-symbol">; </span>pageLayout<span class="tsd-signature-symbol">?: </span><a href="PageLayout.html" class="tsd-signature-type" data-tsd-kind="Type alias">PageLayout</a><span class="tsd-signature-symbol">; </span>pageMode<span class="tsd-signature-symbol">?: </span><a href="PageMode.html" class="tsd-signature-type" data-tsd-kind="Type alias">PageMode</a><span class="tsd-signature-symbol"> }</span></div>
<div class="tsd-comment tsd-typography"><p>A viewer preferences specifying the way the document shall be displayed on the screen.</p>
</div>
<div class="tsd-type-declaration">
<h4>Type declaration</h4>
<ul class="tsd-parameters">
<li class="tsd-parameter">
<h5><code class="tsd-tag ts-flagOptional">Optional</code> center<wbr/>Window<span class="tsd-signature-symbol">?: </span><span class="tsd-signature-type">boolean</span></h5>
<div class="tsd-comment tsd-typography"><p>A flag specifying whether to position the document’s window in the centre of the screen.</p>
</div></li>
<li class="tsd-parameter">
<h5><code class="tsd-tag ts-flagOptional">Optional</code> display<wbr/>Doc<wbr/>Title<span class="tsd-signature-symbol">?: </span><span class="tsd-signature-type">boolean</span></h5>
<div class="tsd-comment tsd-typography"><p>A flag specifying whether the window’s title bar should display the document title taken from the dc:title element of the XMP metadata stream (see 14.3.2, &quot;Metadata streams&quot;). If false, the title bar should instead display the name of the PDF file containing the document.</p>
</div></li>
<li class="tsd-parameter">
<h5><code class="tsd-tag ts-flagOptional">Optional</code> fit<wbr/>Window<span class="tsd-signature-symbol">?: </span><span class="tsd-signature-type">boolean</span></h5>
<div class="tsd-comment tsd-typography"><p>A flag specifying whether to resize the document’s window to fit the size of the first displayed page.</p>
</div></li>
<li class="tsd-parameter">
<h5><code class="tsd-tag ts-flagOptional">Optional</code> hide<wbr/>Menubar<span class="tsd-signature-symbol">?: </span><span class="tsd-signature-type">boolean</span></h5>
<div class="tsd-comment tsd-typography"><p>A flag specifying whether to hide the interactive PDF processor’s menu bar when the document is active. Default value: false.</p>
</div></li>
<li class="tsd-parameter">
...
<div class="tsd-comment tsd-typography"><p>A flag specifying whether to hide the interactive PDF processor’s tool bars when the document is active. Default value: false.</p>
</div></li>
<li class="tsd-parameter">
<h5><code class="tsd-tag ts-flagOptional">Optional</code> hide<wbr/>WindowUI<span class="tsd-signature-symbol">?: </span><span class="tsd-signature-type">boolean</span></h5>
<div class="tsd-comment tsd-typography"><p>A flag specifying whether to hide user interface elements in the document’s window (such as scroll bars and navigation controls), leaving only the document’s contents displayed.</p>
</div></li>
<li class="tsd-parameter">
<h5><code class="tsd-tag ts-flagOptional">Optional</code> non<wbr/>Full<wbr/>Screen<wbr/>Page<wbr/>Mode<span class="tsd-signature-symbol">?: </span><a href="PageMode.html" class="tsd-signature-type" data-tsd-kind="Type alias">PageMode</a></h5>
<div class="tsd-comment tsd-typography"><p>The document’s page mode, specifying how to display the document on exiting full-screen mode</p>
</div></li>
<li class="tsd-parameter">
<h5><code class="tsd-tag ts-flagOptional">Optional</code> open<wbr/>Action<span class="tsd-signature-symbol">?: </span><a href="OpenAction.html" class="tsd-signature-type" data-tsd-kind="Type alias">OpenAction</a></h5>
<div class="tsd-comment tsd-typography"><p>(PDF 1.1) A value specifying a destination that shall be displayed or an action that shall be performed when the document is opened. The value shall be either an array defining a destination (see 12.3.2, &quot;Destinations&quot;) or an action dictionary representing an action (12.6.2, &quot;Action dictionaries&quot;). If this entry is absent, the document shall be opened to the top of the first page at the default magnification factor.</p>
</div></li>
<li class="tsd-parameter">
<h5><code class="tsd-tag ts-flagOptional">Optional</code> page<wbr/>Layout<span class="tsd-signature-symbol">?: </span><a href="PageLayout.html" class="tsd-signature-type" data-tsd-kind="Type alias">PageLayout</a></h5>
<div class="tsd-comment tsd-typography"><p>A name object specifying the page layout shall be used when the document is opened.</p>
</div></li>
<li class="tsd-parameter">
<h5><code class="tsd-tag ts-flagOptional">Optional</code> page<wbr/>Mode<span class="tsd-signature-symbol">?: </span><a href="PageMode.html" class="tsd-signature-type" data-tsd-kind="Type alias">PageMode</a></h5>
<div class="tsd-comment tsd-typography"><p>A name object specifying how the document shall be displayed when opened:</p>
<ul>
<li>UseNone Neither document outline nor thumbnail images visible</li>
<li>UseOutlines Document outline visible</li>
<li>UseThumbs Thumbnail images visible</li>
<li>FullScreen Full-screen mode, with no menu bar, window controls, or any other window visible</li>
<li>UseOC (PDF 1.5) Optional content group panel visible</li>
<li>UseAttachments (PDF 1.6) Attachments panel visible
Default value: UseNone.</li>
</ul>
</div></li></ul></div></div>
...
<li class="current tsd-kind-type-alias"><a href="ViewerPreferences.html" class="tsd-index-link"><svg class="tsd-kind-icon" width="24" height="24" viewBox="0 0 24 24"><use href="#icon-4194304-path"></use><use href="#icon-4194304-text"></use></svg>Viewer<wbr/>Preferences</a></li>
