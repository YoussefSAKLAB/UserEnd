<!DOCTYPE html><html class="default" lang="en"><head><meta charSet="utf-8"/><meta http-equiv="x-ua-compatible" content="IE=edge"/><title>StructTreeNode | Document Solutions PDF Viewer - v7.0.3</title><meta name="description" content="Documentation for Document Solutions PDF Viewer - v7.0.3"/><meta name="viewport" content="width=device-width, initial-scale=1"/><link rel="stylesheet" href="../assets/style.css"/><link rel="stylesheet" href="../assets/highlight.css"/><link rel="stylesheet" href="../assets/custom.css"/><script async src="../assets/search.js" id="search-script"></script></head><body><script>document.documentElement.dataset.theme = localStorage.getItem("tsd-theme") || "os"</script><header class="tsd-page-toolbar">
...
<li><a href="StructTreeNode.html">StructTreeNode</a></li></ul>
<h1>Type alias StructTreeNode</h1></div>
<div class="tsd-signature">Struct<wbr/>Tree<wbr/>Node<span class="tsd-signature-symbol">:</span> <span class="tsd-signature-symbol">{ </span>children<span class="tsd-signature-symbol">: </span><span class="tsd-signature-symbol">(</span><a href="StructTreeNode.html" class="tsd-signature-type" data-tsd-kind="Type alias">StructTreeNode</a><span class="tsd-signature-symbol"> | </span><a href="StructTreeContent.html" class="tsd-signature-type" data-tsd-kind="Type alias">StructTreeContent</a><span class="tsd-signature-symbol">)</span><span class="tsd-signature-symbol">[]</span><span class="tsd-signature-symbol">; </span>role<span class="tsd-signature-symbol">: </span><span class="tsd-signature-type">&quot;Root&quot;</span><span class="tsd-signature-symbol"> | </span><span class="tsd-signature-type">string</span><span class="tsd-signature-symbol"> }</span></div>
<div class="tsd-comment tsd-typography"><p>Structure tree node. The root node will have a role &quot;Root&quot;.</p>
</div>
<div class="tsd-type-declaration">
<h4>Type declaration</h4>
<ul class="tsd-parameters">
<li class="tsd-parameter">
<h5>children<span class="tsd-signature-symbol">: </span><span class="tsd-signature-symbol">(</span><a href="StructTreeNode.html" class="tsd-signature-type" data-tsd-kind="Type alias">StructTreeNode</a><span class="tsd-signature-symbol"> | </span><a href="StructTreeContent.html" class="tsd-signature-type" data-tsd-kind="Type alias">StructTreeContent</a><span class="tsd-signature-symbol">)</span><span class="tsd-signature-symbol">[]</span></h5>
<div class="tsd-comment tsd-typography">
<h3>Property</h3><p>Array of
<a href="StructTreeNode.html">StructTreeNode</a> and <a href="StructTreeContent.html">StructTreeContent</a> objects.</p>
</div></li>
<li class="tsd-parameter">
<h5>role<span class="tsd-signature-symbol">: </span><span class="tsd-signature-type">&quot;Root&quot;</span><span class="tsd-signature-symbol"> | </span><span class="tsd-signature-type">string</span></h5>
<div class="tsd-comment tsd-typography">
<h3>Property</h3><p>element&#39;s role, already mapped if a role map exists
in the PDF.</p>
</div></li></ul></div></div>
...
<li class="current tsd-kind-type-alias"><a href="StructTreeNode.html" class="tsd-index-link"><svg class="tsd-kind-icon" width="24" height="24" viewBox="0 0 24 24"><use href="#icon-4194304-path"></use><use href="#icon-4194304-text"></use></svg>Struct<wbr/>Tree<wbr/>Node</a></li>
