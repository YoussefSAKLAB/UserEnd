...
<li><a href="ScrollPageIntoViewOptions.html">ScrollPageIntoViewOptions</a></li></ul>
<h1>Type alias ScrollPageIntoViewOptions</h1></div>
<div class="tsd-signature">Scroll<wbr/>Page<wbr/>Into<wbr/>View<wbr/>Options<span class="tsd-signature-symbol">:</span> <span class="tsd-signature-type">ScrollIntoViewOptions</span><span class="tsd-signature-symbol"> &amp; </span><span class="tsd-signature-symbol">{ </span>behavior<span class="tsd-signature-symbol">?: </span><span class="tsd-signature-type">ScrollBehavior</span><span class="tsd-signature-symbol">; </span>block<span class="tsd-signature-symbol">?: </span><span class="tsd-signature-type">ScrollLogicalPosition</span><span class="tsd-signature-symbol">; </span>inline<span class="tsd-signature-symbol">?: </span><span class="tsd-signature-type">ScrollLogicalPosition</span><span class="tsd-signature-symbol">; </span>scrollMode<span class="tsd-signature-symbol">?: </span><span class="tsd-signature-type">&quot;always&quot;</span><span class="tsd-signature-symbol"> | </span><span class="tsd-signature-type">&quot;if-needed&quot;</span><span class="tsd-signature-symbol">; </span>visibilityThreshold<span class="tsd-signature-symbol">?: </span><span class="tsd-signature-type">number</span><span class="tsd-signature-symbol"> }</span></div>
<div class="tsd-comment tsd-typography"><p>Options for scrolling the page into view, extending the DOM scroll options type.</p>
</div></div>
...
<li class="current tsd-kind-type-alias"><a href="ScrollPageIntoViewOptions.html" class="tsd-index-link"><svg class="tsd-kind-icon" width="24" height="24" viewBox="0 0 24 24"><use href="#icon-4194304-path"></use><use href="#icon-4194304-text"></use></svg>Scroll<wbr/>Page<wbr/>Into<wbr/>View<wbr/>Options</a></li>
