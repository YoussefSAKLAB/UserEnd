<!DOCTYPE html><html class="default" lang="en"><head><meta charSet="utf-8"/><meta http-equiv="x-ua-compatible" content="IE=edge"/><title>SupportApiSettings | Document Solutions PDF Viewer - v7.0.3</title><meta name="description" content="Documentation for Document Solutions PDF Viewer - v7.0.3"/><meta name="viewport" content="width=device-width, initial-scale=1"/><link rel="stylesheet" href="../assets/style.css"/><link rel="stylesheet" href="../assets/highlight.css"/><link rel="stylesheet" href="../assets/custom.css"/><script async src="../assets/search.js" id="search-script"></script></head><body><script>document.documentElement.dataset.theme = localStorage.getItem("tsd-theme") || "os"</script><header class="tsd-page-toolbar">
...
<li><a href="SupportApiSettings.html">SupportApiSettings</a></li></ul>
<h1>Type alias SupportApiSettings</h1></div>
<div class="tsd-signature">Support<wbr/>Api<wbr/>Settings<span class="tsd-signature-symbol">:</span> <span class="tsd-signature-symbol">{ </span>apiUrl<span class="tsd-signature-symbol">: </span><span class="tsd-signature-type">string</span><span class="tsd-signature-symbol">; </span>legacyServer<span class="tsd-signature-symbol">?: </span><span class="tsd-signature-type">boolean</span><span class="tsd-signature-symbol">; </span>reconnectInterval<span class="tsd-signature-symbol">?: </span><span class="tsd-signature-type">number</span><span class="tsd-signature-symbol">; </span>requestInit<span class="tsd-signature-symbol">?: </span><span class="tsd-signature-type">RequestInit</span><span class="tsd-signature-symbol">; </span>suppressErrorMessages<span class="tsd-signature-symbol">?: </span><span class="tsd-signature-type">boolean</span><span class="tsd-signature-symbol">; </span>suppressInfoMessages<span class="tsd-signature-symbol">?: </span><span class="tsd-signature-type">boolean</span><span class="tsd-signature-symbol">; </span>token<span class="tsd-signature-symbol">?: </span><span class="tsd-signature-type">string</span><span class="tsd-signature-symbol">; </span>webSocketUrl<span class="tsd-signature-symbol">?: </span><span class="tsd-signature-type">string</span><span class="tsd-signature-symbol"> | </span><span class="tsd-signature-type">false</span><span class="tsd-signature-symbol"> }</span></div>
<div class="tsd-comment tsd-typography"><p>Represents the settings for the SupportApi.</p>
</div>
...
<div class="tsd-comment tsd-typography"><p>URL to the Support API service that will be used to enable PDF editing features.</p>
</div></li>
<li class="tsd-parameter">
<h5><code class="tsd-tag ts-flagOptional">Optional</code> legacy<wbr/>Server<span class="tsd-signature-symbol">?: </span><span class="tsd-signature-type">boolean</span></h5>
<div class="tsd-comment tsd-typography"><p>Set this setting to true if you are using the Web Forms (WEB API 2) version of the SupportApi service. 
Note, in most cases, you do not need to set this setting, the server type is determined by the viewer automatically.</p>

<h3>Example</h3><pre><code class="language-javascript"><span class="hl-0">const</span><span class="hl-1"> </span><span class="hl-6">viewer</span><span class="hl-1"> = </span><span class="hl-0">new</span><span class="hl-1"> </span><span class="hl-3">DsPdfViewer</span><span class="hl-1">(</span><span class="hl-4">&quot;#viewer&quot;</span><span class="hl-1">, {</span><br/><span class="hl-1">  </span><span class="hl-2">supportApi:</span><span class="hl-1"> {</span><br/><span class="hl-1">    </span><span class="hl-2">apiUrl:</span><span class="hl-1"> </span><span class="hl-4">&quot;/api/pdf-viewer&quot;</span><span class="hl-1">,</span><br/><span class="hl-1">    </span><span class="hl-2">webSocketUrl:</span><span class="hl-1"> </span><span class="hl-4">&quot;/signalr&quot;</span><span class="hl-1">,</span><br/><span class="hl-1">    </span><span class="hl-2">legacyServer:</span><span class="hl-1"> </span><span class="hl-0">true</span><span class="hl-1">,</span><br/><span class="hl-1">    </span><span class="hl-2">token:</span><span class="hl-1"> </span><span class="hl-4">&quot;support-api-demo-net-core-token&quot;</span><br/><span class="hl-1">  }</span><br/><span class="hl-1">});</span>
</code></pre>
</div></li>
<li class="tsd-parameter">
<h5><code class="tsd-tag ts-flagOptional">Optional</code> reconnect<wbr/>Interval<span class="tsd-signature-symbol">?: </span><span class="tsd-signature-type">number</span></h5>
<div class="tsd-comment tsd-typography"><p>Automatically reconnect to the server at the specified interval in milliseconds.
Used by persistent connections.</p>

<h3>Default</h3><p>5000</p>
</div></li>
<li class="tsd-parameter">
<h5><code class="tsd-tag ts-flagOptional">Optional</code> request<wbr/>Init<span class="tsd-signature-symbol">?: </span><span class="tsd-signature-type">RequestInit</span></h5>
<div class="tsd-comment tsd-typography"><p>The internal Support API client uses the fetch API to make requests to the server.
Use the requestInit setting to configure fetch options (like authorization headers, etc),
see <a href="https://developer.mozilla.org/en-US/docs/Web/API/Fetch_API/Using_Fetch">https://developer.mozilla.org/en-US/docs/Web/API/Fetch_API/Using_Fetch</a> for details.</p>

<h3>Example</h3><pre><code class="language-javascript"><span class="hl-5">// Include Basic Authentication headers:</span><br/><span class="hl-0">const</span><span class="hl-1"> </span><span class="hl-6">viewer</span><span class="hl-1"> = </span><span class="hl-0">new</span><span class="hl-1"> </span><span class="hl-3">DsPdfViewer</span><span class="hl-1">(</span><span class="hl-4">&quot;#viewer&quot;</span><span class="hl-1">, {</span><br/><span class="hl-1">  </span><span class="hl-2">supportApi:</span><span class="hl-1"> {</span><br/><span class="hl-1">    </span><span class="hl-2">apiUrl:</span><span class="hl-1"> </span><span class="hl-4">&quot;192.168.0.1/support-api&quot;</span><span class="hl-1">,</span><br/><span class="hl-1">    </span><span class="hl-2">requestInit:</span><span class="hl-1"> { </span><br/><span class="hl-1">      </span><span class="hl-2">headers:</span><span class="hl-1"> {</span><br/><span class="hl-1">        </span><span class="hl-4">&quot;Authorization&quot;</span><span class="hl-2">:</span><span class="hl-1"> </span><span class="hl-4">&quot;Basic &quot;</span><span class="hl-1"> + </span><span class="hl-3">btoa</span><span class="hl-1">(</span><span class="hl-3">unescape</span><span class="hl-1">(</span><span class="hl-3">encodeURIComponent</span><span class="hl-1">(</span><span class="hl-4">&quot;USERNAME:PASSWORD&quot;</span><span class="hl-1">))),</span><br/><span class="hl-1">        </span><span class="hl-4">&quot;CustomHeader&quot;</span><span class="hl-2">:</span><span class="hl-1"> </span><span class="hl-4">&quot;Custom header value&quot;</span><br/><span class="hl-1">      }</span><br/><span class="hl-1">    }</span><br/><span class="hl-1">  }</span><br/><span class="hl-1">});</span>
</code></pre>
</div></li>
<li class="tsd-parameter">
<h5><code class="tsd-tag ts-flagOptional">Optional</code> suppress<wbr/>Error<wbr/>Messages<span class="tsd-signature-symbol">?: </span><span class="tsd-signature-type">boolean</span></h5>
<div class="tsd-comment tsd-typography"><p>Suppress Support API error messages (e.g. messages about the Support API availability / version mismatch).</p>

<h3>Example</h3><pre><code class="language-javascript"><span class="hl-5">// Suppress both error and informational messages:</span><br/><span class="hl-0">const</span><span class="hl-1"> </span><span class="hl-6">viewer</span><span class="hl-1"> = </span><span class="hl-0">new</span><span class="hl-1"> </span><span class="hl-3">DsPdfViewer</span><span class="hl-1">(</span><span class="hl-4">&quot;#viewer&quot;</span><span class="hl-1">, {</span><br/><span class="hl-1">  </span><span class="hl-2">supportApi:</span><span class="hl-1"> {</span><br/><span class="hl-1">    </span><span class="hl-2">apiUrl:</span><span class="hl-1"> </span><span class="hl-4">&quot;http://192.168.0.1/support-api&quot;</span><span class="hl-1">,</span><br/><span class="hl-1">    </span><span class="hl-2">webSocketUrl:</span><span class="hl-1"> </span><span class="hl-0">false</span><span class="hl-1">,</span><br/><span class="hl-1">    </span><span class="hl-2">suppressInfoMessages:</span><span class="hl-1"> </span><span class="hl-0">true</span><span class="hl-1">,</span><br/><span class="hl-1">    </span><span class="hl-2">suppressErrorMessages:</span><span class="hl-1"> </span><span class="hl-0">true</span><br/><span class="hl-1">  }</span><br/><span class="hl-1">});</span>
</code></pre>
</div></li>
<li class="tsd-parameter">
<h5><code class="tsd-tag ts-flagOptional">Optional</code> suppress<wbr/>Info<wbr/>Messages<span class="tsd-signature-symbol">?: </span><span class="tsd-signature-type">boolean</span></h5>
<div class="tsd-comment tsd-typography"><p>Suppress Support API informational messages (e.g. Support API reconnect messages).</p>

<h3>Example</h3><pre><code class="language-javascript"><span class="hl-5">// Suppress informational messages only:</span><br/><span class="hl-0">const</span><span class="hl-1"> </span><span class="hl-6">viewer</span><span class="hl-1"> = </span><span class="hl-0">new</span><span class="hl-1"> </span><span class="hl-3">DsPdfViewer</span><span class="hl-1">(</span><span class="hl-4">&quot;#viewer&quot;</span><span class="hl-1">, {</span><br/><span class="hl-1">  </span><span class="hl-2">supportApi:</span><span class="hl-1"> {</span><br/><span class="hl-1">    </span><span class="hl-2">apiUrl:</span><span class="hl-1"> </span><span class="hl-4">&quot;http://192.168.0.1/support-api&quot;</span><span class="hl-1">,</span><br/><span class="hl-1">    </span><span class="hl-2">webSocketUrl:</span><span class="hl-1"> </span><span class="hl-0">false</span><span class="hl-1">,</span><br/><span class="hl-1">    </span><span class="hl-2">suppressInfoMessages:</span><span class="hl-1"> </span><span class="hl-0">true</span><br/><span class="hl-1">  }</span><br/><span class="hl-1">});</span>
</code></pre>
</div></li>
<li class="tsd-parameter">
<h5><code class="tsd-tag ts-flagOptional">Optional</code> token<span class="tsd-signature-symbol">?: </span><span class="tsd-signature-type">string</span></h5>
<div class="tsd-comment tsd-typography"><p>Authentication or antiforgery token. In each subsequent SupportApi request, the token is passed in the request for server-side validation.
You can use ASP.NET Core Antiforgery to generate and verify security token, see <a href="https://docs.microsoft.com/en-us/aspnet/core/security/anti-request-forgery?view=aspnetcore-6.0%7CPrevent">Cross-Site Request Forgery (XSRF/CSRF) attacks in ASP.NET Core</a> for details.</p>

<h3>Example</h3><pre><code class="language-javascript"><span class="hl-5">// Specify antiforgery token on client side:</span><br/><span class="hl-0">const</span><span class="hl-1"> </span><span class="hl-6">viewer</span><span class="hl-1"> = </span><span class="hl-0">new</span><span class="hl-1"> </span><span class="hl-3">DsPdfViewer</span><span class="hl-1">(</span><span class="hl-4">&quot;#viewer&quot;</span><span class="hl-1">, {</span><br/><span class="hl-1">  </span><span class="hl-2">supportApi:</span><span class="hl-1"> {</span><br/><span class="hl-1">    </span><span class="hl-2">apiUrl:</span><span class="hl-1"> </span><span class="hl-4">&quot;192.168.0.1/support-api&quot;</span><span class="hl-1">,</span><br/><span class="hl-1">    </span><span class="hl-2">token:</span><span class="hl-1"> </span><span class="hl-4">&quot;support-api-demo-net-core-token&quot;</span><span class="hl-1">,</span><br/><span class="hl-1">    </span><span class="hl-2">webSocketUrl:</span><span class="hl-1"> </span><span class="hl-0">false</span><br/><span class="hl-1">  }</span><br/><span class="hl-1">});</span>
</code></pre>

<h3>Example</h3><pre><code class="language-csharp"><span class="hl-5">// Here is an example of how to validate the token on the server side inside the SupportApi service project:</span><br/><br/><span class="hl-5">// Startup.cs:</span><br/><span class="hl-2">GcPdfViewerController</span><span class="hl-1">.</span><span class="hl-2">Settings</span><span class="hl-1">.</span><span class="hl-2">VerifyToken</span><span class="hl-1"> += </span><span class="hl-2">VerifyAuthToken</span><span class="hl-1">;</span><br/><br/><span class="hl-0">private</span><span class="hl-1"> </span><span class="hl-0">void</span><span class="hl-1"> </span><span class="hl-3">VerifyAuthToken</span><span class="hl-1">(</span><span class="hl-0">object</span><span class="hl-1"> </span><span class="hl-2">sender</span><span class="hl-1">, </span><span class="hl-9">SupportApi</span><span class="hl-1">.</span><span class="hl-9">Models</span><span class="hl-1">.</span><span class="hl-9">VerifyTokenEventArgs</span><span class="hl-1"> </span><span class="hl-2">e</span><span class="hl-1">)</span><br/><span class="hl-1">{</span><br/><span class="hl-1">   </span><span class="hl-0">string</span><span class="hl-1"> </span><span class="hl-2">token</span><span class="hl-1"> = </span><span class="hl-2">e</span><span class="hl-1">.</span><span class="hl-2">Token</span><span class="hl-1">;</span><br/><span class="hl-1">   </span><span class="hl-7">if</span><span class="hl-1"> (</span><span class="hl-2">token</span><span class="hl-1"> != </span><span class="hl-4">&quot;support-api-demo-net-core-token&quot;</span><span class="hl-1">)</span><br/><span class="hl-1">   {</span><br/><span class="hl-1">       </span><span class="hl-2">e</span><span class="hl-1">.</span><span class="hl-2">Reject</span><span class="hl-1"> = </span><span class="hl-0">true</span><span class="hl-1">;</span><br/><span class="hl-1">   }</span><br/><span class="hl-1">}</span>
</code></pre>
</div></li>
<li class="tsd-parameter">
<h5><code class="tsd-tag ts-flagOptional">Optional</code> web<wbr/>Socket<wbr/>Url<span class="tsd-signature-symbol">?: </span><span class="tsd-signature-type">string</span><span class="tsd-signature-symbol"> | </span><span class="tsd-signature-type">false</span></h5>
<div class="tsd-comment tsd-typography"><p>Optional. SignalR socket URL for persistent connections. 
Persistent connections are required for collaboration mode.
Set this setting to false to disable persistent connections.</p>

<h3>Default</h3><p>/signalr</p>
</div></li></ul></div></div>
...
<li class="current tsd-kind-type-alias"><a href="SupportApiSettings.html" class="tsd-index-link"><svg class="tsd-kind-icon" width="24" height="24" viewBox="0 0 24 24"><use href="#icon-4194304-path"></use><use href="#icon-4194304-text"></use></svg>Support<wbr/>Api<wbr/>Settings</a></li>
