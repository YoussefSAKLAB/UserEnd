...
import { OpenParameters, OptionalContentConfig, PageViewport, SaveSettings, StructTreeNode, ViewerFeatureName, ViewerPreferences, IGCEventBus, DocumentListItem, SubmitFormOptions, ScrollPageIntoViewOptions, IGcPageView } from './Models/ViewerTypes';
...
export declare class GcPdfViewer extends ReportViewer {
    ...
    getType(typeName: string): typeof React | typeof AnnotationBase | typeof GcPdfViewer | typeof ReactDOM | typeof AsyncLock | typeof PdfReportPlugin | typeof AnnotationTypeCode | typeof utf8ToBase64 | typeof PromiseQueue | typeof EditMode | typeof GenericButton | typeof ViewerStatus | typeof ViewerOptions | typeof LayoutMode | typeof Toolbar | typeof ViewMode | typeof ZoomMode | typeof GcMeasurement | typeof GcPdfSearcher | typeof GcRightSidebar | null;
    ...
    toggleSearchUI(forceExpand?: boolean): void;
    ...
    checkAnnotationLocked(annotation: AnnotationBase, editType?: "Any" | "EditProperty" | "Delete" | "EditContents", showErrorMessage?: boolean): boolean;
    invalidate(): void;
    markAnnotationLayerDirty(pageIndex: number | number[]): any;
    getPageView(pageIndex: number): IGcPageView | undefined;
    ...
    close(): Promise<void>;
    static getBlankDocumentBytes(): Uint8Array;
    ...
    saveAsImages(fileName?: string, settings?: SaveSettings): Promise<boolean>;
    saveChanges(): Promise<boolean>;
    submitForm(submitUrl: string, options?: SubmitFormOptions): Promise<void>;
    resetForm(): void;
    ...
    addDocumentListPanel(documentListUrl?: string | DocumentListItem[]): PanelHandle;
    ...
    getSelectedTextCoordinates(): null | {
        pageIndex: number;
        outerRect: number[];
        quadPoints: {
            x: number;
    ...
    get selectionCopier(): any;
    collectQuadPoints(paintedBoxes: PaintedBoxInfo[]): TextPartsQuadPoints;
    pushModificationsState(modificationsState: ModificationsState): void;
    convertPdfRectToWindowCoordinates(pageIndex: number, rect: number[] | Rect): number[];
    ...
    openSharedDocumentByName(fileName: string): Promise<OpenDocumentInfo | null>;
    openSharedDocumentByIndex(sharedDocIndex: number): Promise<OpenDocumentInfo | null>;
    getSharedDocuments(): Promise<SharedDocumentInfo[] | null>;
