...
<li><a href="SignatureInformation.html">SignatureInformation</a></li></ul>
<h1>Type alias SignatureInformation</h1></div>
<div class="tsd-signature">Signature<wbr/>Information<span class="tsd-signature-symbol">:</span> <span class="tsd-signature-symbol">{ </span>signatureFields<span class="tsd-signature-symbol">: </span><a href="../classes/SignatureAnnotation.html" class="tsd-signature-type" data-tsd-kind="Class">SignatureAnnotation</a><span class="tsd-signature-symbol">[]</span><span class="tsd-signature-symbol">; </span>signed<span class="tsd-signature-symbol">: </span><span class="tsd-signature-type">boolean</span><span class="tsd-signature-symbol">; </span>signedByFields<span class="tsd-signature-symbol">: </span><a href="../classes/SignatureAnnotation.html" class="tsd-signature-type" data-tsd-kind="Class">SignatureAnnotation</a><span class="tsd-signature-symbol">[]</span><span class="tsd-signature-symbol"> }</span></div>
<div class="tsd-comment tsd-typography"><p>Information about signature used in document.</p>
</div>
<div class="tsd-type-declaration">
<h4>Type declaration</h4>
<ul class="tsd-parameters">
<li class="tsd-parameter">
<h5>signature<wbr/>Fields<span class="tsd-signature-symbol">: </span><a href="../classes/SignatureAnnotation.html" class="tsd-signature-type" data-tsd-kind="Class">SignatureAnnotation</a><span class="tsd-signature-symbol">[]</span></h5>
<div class="tsd-comment tsd-typography"><p>An array with all available signature fields in the document.
The signatureFields represents all signature fields in a file, whether it is signed or not.</p>
</div></li>
<li class="tsd-parameter">
<h5>signed<span class="tsd-signature-symbol">: </span><span class="tsd-signature-type">boolean</span></h5>
<div class="tsd-comment tsd-typography"><p>The flag indicates whether the document is signed. 
Note, a document is considered signed if it contains at least 
one signature field with the signatureValue property filled in.</p>
</div></li>
<li class="tsd-parameter">
<h5>signed<wbr/>By<wbr/>Fields<span class="tsd-signature-symbol">: </span><a href="../classes/SignatureAnnotation.html" class="tsd-signature-type" data-tsd-kind="Class">SignatureAnnotation</a><span class="tsd-signature-symbol">[]</span></h5>
<div class="tsd-comment tsd-typography"><p>An array with signature field(s) which was used to sign the document.
The signedByFields only represents signed signature fields.</p>
</div></li></ul></div></div>
...
<li class="current tsd-kind-type-alias"><a href="SignatureInformation.html" class="tsd-index-link"><svg class="tsd-kind-icon" width="24" height="24" viewBox="0 0 24 24"><use href="#icon-4194304-path"></use><use href="#icon-4194304-text"></use></svg>Signature<wbr/>Information</a></li>
