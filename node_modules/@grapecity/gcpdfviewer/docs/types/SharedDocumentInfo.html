...
<li><a href="SharedDocumentInfo.html">SharedDocumentInfo</a></li></ul>
<h1>Type alias SharedDocumentInfo</h1></div>
<div class="tsd-signature">Shared<wbr/>Document<wbr/>Info<span class="tsd-signature-symbol">:</span> <span class="tsd-signature-symbol">{ </span>accessMode<span class="tsd-signature-symbol">: </span><a href="../enums/SharedAccessMode.html" class="tsd-signature-type" data-tsd-kind="Enumeration">SharedAccessMode</a><span class="tsd-signature-symbol">; </span>documentId<span class="tsd-signature-symbol">: </span><span class="tsd-signature-type">string</span><span class="tsd-signature-symbol">; </span>fileName<span class="tsd-signature-symbol">: </span><span class="tsd-signature-type">string</span><span class="tsd-signature-symbol">; </span>ownerUserName<span class="tsd-signature-symbol">: </span><span class="tsd-signature-type">string</span><span class="tsd-signature-symbol">; </span>userName<span class="tsd-signature-symbol">: </span><span class="tsd-signature-type">string</span><span class="tsd-signature-symbol"> }</span></div>
<div class="tsd-comment tsd-typography"><p>Information about shared document.</p>
</div>
<div class="tsd-type-declaration">
<h4>Type declaration</h4>
<ul class="tsd-parameters">
<li class="tsd-parameter">
<h5>access<wbr/>Mode<span class="tsd-signature-symbol">: </span><a href="../enums/SharedAccessMode.html" class="tsd-signature-type" data-tsd-kind="Enumeration">SharedAccessMode</a></h5></li>
<li class="tsd-parameter">
<h5>document<wbr/>Id<span class="tsd-signature-symbol">: </span><span class="tsd-signature-type">string</span></h5></li>
<li class="tsd-parameter">
<h5>file<wbr/>Name<span class="tsd-signature-symbol">: </span><span class="tsd-signature-type">string</span></h5></li>
<li class="tsd-parameter">
<h5>owner<wbr/>User<wbr/>Name<span class="tsd-signature-symbol">: </span><span class="tsd-signature-type">string</span></h5></li>
<li class="tsd-parameter">
<h5>user<wbr/>Name<span class="tsd-signature-symbol">: </span><span class="tsd-signature-type">string</span></h5></li></ul></div></div>
...
<li class="current tsd-kind-type-alias"><a href="SharedDocumentInfo.html" class="tsd-index-link"><svg class="tsd-kind-icon" width="24" height="24" viewBox="0 0 24 24"><use href="#icon-4194304-path"></use><use href="#icon-4194304-text"></use></svg>Shared<wbr/>Document<wbr/>Info</a></li>
