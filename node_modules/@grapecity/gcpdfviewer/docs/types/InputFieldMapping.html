<!DOCTYPE html><html class="default" lang="en"><head><meta charSet="utf-8"/><meta http-equiv="x-ua-compatible" content="IE=edge"/><title>InputFieldMapping | Document Solutions PDF Viewer - v7.0.3</title><meta name="description" content="Documentation for Document Solutions PDF Viewer - v7.0.3"/><meta name="viewport" content="width=device-width, initial-scale=1"/><link rel="stylesheet" href="../assets/style.css"/><link rel="stylesheet" href="../assets/highlight.css"/><link rel="stylesheet" href="../assets/custom.css"/><script async src="../assets/search.js" id="search-script"></script></head><body><script>document.documentElement.dataset.theme = localStorage.getItem("tsd-theme") || "os"</script><header class="tsd-page-toolbar">
...
<li><a href="InputFieldMapping.html">InputFieldMapping</a></li></ul>
<h1>Type alias InputFieldMapping</h1></div>
<div class="tsd-signature">Input<wbr/>Field<wbr/>Mapping<span class="tsd-signature-symbol">:</span> <span class="tsd-signature-symbol">{ </span>hidden<span class="tsd-signature-symbol">?: </span><span class="tsd-signature-type">boolean</span><span class="tsd-signature-symbol">; </span>nolabel<span class="tsd-signature-symbol">?: </span><span class="tsd-signature-type">boolean</span><span class="tsd-signature-symbol">; </span>orderindex<span class="tsd-signature-symbol">?: </span><span class="tsd-signature-type">number</span><span class="tsd-signature-symbol">; </span>rowcustomcss<span class="tsd-signature-symbol">?: </span><span class="tsd-signature-type">string</span><span class="tsd-signature-symbol">; </span>validator<span class="tsd-signature-symbol">?: </span><span class="tsd-signature-symbol">(</span><span class="tsd-signature-symbol">(</span>fieldValue<span class="tsd-signature-symbol">: </span><span class="tsd-signature-type">string</span><span class="tsd-signature-symbol"> | </span><span class="tsd-signature-type">string</span><span class="tsd-signature-symbol">[]</span>, field<span class="tsd-signature-symbol">: </span><a href="../classes/WidgetAnnotation.html" class="tsd-signature-type" data-tsd-kind="Class">WidgetAnnotation</a>, args<span class="tsd-signature-symbol">: </span><span class="tsd-signature-symbol">{ </span>caller<span class="tsd-signature-symbol">: </span><span class="tsd-signature-type">ValidationCallerType</span><span class="tsd-signature-symbol"> }</span><span class="tsd-signature-symbol">)</span><span class="tsd-signature-symbol"> =&gt; </span><span class="tsd-signature-type">boolean</span><span class="tsd-signature-symbol"> | </span><span class="tsd-signature-type">string</span><span class="tsd-signature-symbol">)</span><span class="tsd-signature-symbol"> }</span></div>
<div class="tsd-comment tsd-typography"><p>Defines appearance, behavior, and validation settings for the input field inside the Form Filler dialog.</p>
</div>
<div class="tsd-type-declaration">
<h4>Type declaration</h4>
<ul class="tsd-parameters">
<li class="tsd-parameter">
<h5><code class="tsd-tag ts-flagOptional">Optional</code> hidden<span class="tsd-signature-symbol">?: </span><span class="tsd-signature-type">boolean</span></h5>
<div class="tsd-comment tsd-typography">
<h3>Property</h3><p>Set to true to hide the field from the list of Form Filler fields.</p>
</div></li>
<li class="tsd-parameter">
<h5><code class="tsd-tag ts-flagOptional">Optional</code> nolabel<span class="tsd-signature-symbol">?: </span><span class="tsd-signature-type">boolean</span></h5>
<div class="tsd-comment tsd-typography">
<h3>Property</h3><p>Set to true to hide the field label and display the full-width input control.</p>
</div></li>
<li class="tsd-parameter">
<h5><code class="tsd-tag ts-flagOptional">Optional</code> orderindex<span class="tsd-signature-symbol">?: </span><span class="tsd-signature-type">number</span></h5>
<div class="tsd-comment tsd-typography">
<h3>Property</h3><p>Optional. Specifies the order of fields in the Form Filler dialog box.</p>
</div></li>
<li class="tsd-parameter">
<h5><code class="tsd-tag ts-flagOptional">Optional</code> rowcustomcss<span class="tsd-signature-symbol">?: </span><span class="tsd-signature-type">string</span></h5>
<div class="tsd-comment tsd-typography">
<h3>Property</h3><p>Applies an additional custom CSS class to the outer DOM container of the form field input control.</p>
</div></li>
<li class="tsd-parameter">
...
<li class="tsd-signature" id="__type.__type-1.__type-2"><span class="tsd-signature-symbol">(</span>fieldValue<span class="tsd-signature-symbol">: </span><span class="tsd-signature-type">string</span><span class="tsd-signature-symbol"> | </span><span class="tsd-signature-type">string</span><span class="tsd-signature-symbol">[]</span>, field<span class="tsd-signature-symbol">: </span><a href="../classes/WidgetAnnotation.html" class="tsd-signature-type" data-tsd-kind="Class">WidgetAnnotation</a>, args<span class="tsd-signature-symbol">: </span><span class="tsd-signature-symbol">{ </span>caller<span class="tsd-signature-symbol">: </span><span class="tsd-signature-type">ValidationCallerType</span><span class="tsd-signature-symbol"> }</span><span class="tsd-signature-symbol">)</span><span class="tsd-signature-symbol">: </span><span class="tsd-signature-type">boolean</span><span class="tsd-signature-symbol"> | </span><span class="tsd-signature-type">string</span></li>
<li class="tsd-description">
<div class="tsd-comment tsd-typography">
<h3>Property</h3><p>Custom validator function called on the mapped field before saving changes or after changing the value
      if GcProps.validateoninput is set to true.
      Return true or null for a successful result. Return a string with a validation error message for failure
      (to be displayed in the user interface).</p>
</div>
...
<li class="current tsd-kind-type-alias"><a href="InputFieldMapping.html" class="tsd-index-link"><svg class="tsd-kind-icon" width="24" height="24" viewBox="0 0 24 24"><use href="#icon-4194304-path"></use><use href="#icon-4194304-text"></use></svg>Input<wbr/>Field<wbr/>Mapping</a></li>
