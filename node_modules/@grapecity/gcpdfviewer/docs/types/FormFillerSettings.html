<!DOCTYPE html><html class="default" lang="en"><head><meta charSet="utf-8"/><meta http-equiv="x-ua-compatible" content="IE=edge"/><title>FormFillerSettings | Document Solutions PDF Viewer - v7.0.3</title><meta name="description" content="Documentation for Document Solutions PDF Viewer - v7.0.3"/><meta name="viewport" content="width=device-width, initial-scale=1"/><link rel="stylesheet" href="../assets/style.css"/><link rel="stylesheet" href="../assets/highlight.css"/><link rel="stylesheet" href="../assets/custom.css"/><script async src="../assets/search.js" id="search-script"></script></head><body><script>document.documentElement.dataset.theme = localStorage.getItem("tsd-theme") || "os"</script><header class="tsd-page-toolbar">
...
<li><a href="FormFillerSettings.html">FormFillerSettings</a></li></ul>
<h1>Type alias FormFillerSettings</h1></div>
<div class="tsd-signature">Form<wbr/>Filler<wbr/>Settings<span class="tsd-signature-symbol">:</span> <span class="tsd-signature-symbol">{ </span>applyAfterFailedValidation<span class="tsd-signature-symbol">?: </span><span class="tsd-signature-type">&quot;confirm&quot;</span><span class="tsd-signature-symbol"> | </span><span class="tsd-signature-type">&quot;reject&quot;</span><span class="tsd-signature-symbol"> | </span><span class="tsd-signature-type">&quot;apply&quot;</span><span class="tsd-signature-symbol"> | </span><span class="tsd-signature-type">Function</span><span class="tsd-signature-symbol">; </span>beforeApplyChanges<span class="tsd-signature-symbol">?: </span><span class="tsd-signature-symbol">(</span><span class="tsd-signature-symbol">(</span>formFiller<span class="tsd-signature-symbol">: </span><span class="tsd-signature-type">any</span><span class="tsd-signature-symbol">)</span><span class="tsd-signature-symbol"> =&gt; </span><span class="tsd-signature-type">boolean</span><span class="tsd-signature-symbol">)</span><span class="tsd-signature-symbol">; </span>beforeFieldChange<span class="tsd-signature-symbol">?: </span><span class="tsd-signature-symbol">(</span><span class="tsd-signature-symbol">(</span>field<span class="tsd-signature-symbol">: </span><a href="../classes/WidgetAnnotation.html" class="tsd-signature-type" data-tsd-kind="Class">WidgetAnnotation</a>, formFiller<span class="tsd-signature-symbol">: </span><span class="tsd-signature-type">any</span><span class="tsd-signature-symbol">)</span><span class="tsd-signature-symbol"> =&gt; </span><span class="tsd-signature-type">boolean</span><span class="tsd-signature-symbol">)</span><span class="tsd-signature-symbol">; </span>layout<span class="tsd-signature-symbol">?: </span><span class="tsd-signature-type">&quot;Auto&quot;</span><span class="tsd-signature-symbol"> | </span><span class="tsd-signature-type">&quot;OneColumn&quot;</span><span class="tsd-signature-symbol"> | </span><span class="tsd-signature-type">&quot;TwoColumns&quot;</span><span class="tsd-signature-symbol">; </span>mappings<span class="tsd-signature-symbol">: </span><span class="tsd-signature-symbol">{ </span>[fieldName: <span class="tsd-signature-type">string</span>]<span class="tsd-signature-symbol">: </span><a href="FormFieldMapping.html" class="tsd-signature-type" data-tsd-kind="Type alias">FormFieldMapping</a><span class="tsd-signature-symbol"> }</span><span class="tsd-signature-symbol">; </span>onInitialize<span class="tsd-signature-symbol">?: </span><span class="tsd-signature-symbol">(</span><span class="tsd-signature-symbol">(</span>formFiller<span class="tsd-signature-symbol">: </span><span class="tsd-signature-type">any</span><span class="tsd-signature-symbol">)</span><span class="tsd-signature-symbol"> =&gt; </span><span class="tsd-signature-type">void</span><span class="tsd-signature-symbol">)</span><span class="tsd-signature-symbol">; </span>title<span class="tsd-signature-symbol">?: </span><span class="tsd-signature-type">string</span><span class="tsd-signature-symbol">; </span>validator<span class="tsd-signature-symbol">?: </span><span class="tsd-signature-symbol">(</span><span class="tsd-signature-symbol">(</span>fieldValue<span class="tsd-signature-symbol">: </span><span class="tsd-signature-type">string</span><span class="tsd-signature-symbol"> | </span><span class="tsd-signature-type">string</span><span class="tsd-signature-symbol">[]</span>, field<span class="tsd-signature-symbol">: </span><a href="../classes/WidgetAnnotation.html" class="tsd-signature-type" data-tsd-kind="Class">WidgetAnnotation</a>, args<span class="tsd-signature-symbol">: </span><span class="tsd-signature-symbol">{ </span>caller<span class="tsd-signature-symbol">: </span><span class="tsd-signature-type">ValidationCallerType</span><span class="tsd-signature-symbol"> }</span><span class="tsd-signature-symbol">)</span><span class="tsd-signature-symbol"> =&gt; </span><span class="tsd-signature-type">boolean</span><span class="tsd-signature-symbol"> | </span><span class="tsd-signature-type">string</span><span class="tsd-signature-symbol">)</span><span class="tsd-signature-symbol"> }</span></div>
...
<h5><code class="tsd-tag ts-flagOptional">Optional</code> apply<wbr/>After<wbr/>Failed<wbr/>Validation<span class="tsd-signature-symbol">?: </span><span class="tsd-signature-type">&quot;confirm&quot;</span><span class="tsd-signature-symbol"> | </span><span class="tsd-signature-type">&quot;reject&quot;</span><span class="tsd-signature-symbol"> | </span><span class="tsd-signature-type">&quot;apply&quot;</span><span class="tsd-signature-symbol"> | </span><span class="tsd-signature-type">Function</span></h5>
<div class="tsd-comment tsd-typography"><p>The type of action to execute if form validation fails after clicking Apply button.</p>

<h3>Default</h3><p>confirm</p>

<h3>Example</h3><p>Reject apply changes when validation fails:</p>
<pre><code class="language-javascript"><span class="hl-1">     </span><span class="hl-2">options</span><span class="hl-1">.</span><span class="hl-2">formFiller</span><span class="hl-1"> = {</span><br/><span class="hl-1">           </span><span class="hl-2">applyAfterFailedValidation:</span><span class="hl-1"> </span><span class="hl-4">&#39;reject&#39;</span><br/><span class="hl-1">     }</span>
</code></pre>
<ul>
<li></li>
</ul>

<h3>Example</h3><p>Execute custom function and reject changes</p>
<pre><code class="language-javascript"><span class="hl-1">     </span><span class="hl-2">options</span><span class="hl-1">.</span><span class="hl-2">formFiller</span><span class="hl-1"> = {</span><br/><span class="hl-1">           </span><span class="hl-3">applyAfterFailedValidation</span><span class="hl-2">:</span><span class="hl-1"> </span><span class="hl-0">function</span><span class="hl-1">() { </span><br/><span class="hl-1">              </span><span class="hl-3">alert</span><span class="hl-1">(</span><span class="hl-4">&#39;Validation failed, changes rejected.&#39;</span><span class="hl-1">); </span><br/><span class="hl-1">              </span><span class="hl-7">return</span><span class="hl-1"> </span><span class="hl-0">false</span><span class="hl-1">; </span><br/><span class="hl-1">           }</span><br/><span class="hl-1">     }</span>
</code></pre>

<h3>Example</h3><p>Execute custom function and accept changes</p>
<pre><code class="language-javascript"><span class="hl-1">     </span><span class="hl-2">options</span><span class="hl-1">.</span><span class="hl-2">formFiller</span><span class="hl-1"> = {</span><br/><span class="hl-1">           </span><span class="hl-3">applyAfterFailedValidation</span><span class="hl-2">:</span><span class="hl-1"> </span><span class="hl-0">function</span><span class="hl-1">() { </span><br/><span class="hl-1">              </span><span class="hl-3">alert</span><span class="hl-1">(</span><span class="hl-4">&#39;Validation failed, but changes will be accepted.&#39;</span><span class="hl-1">); </span><br/><span class="hl-1">              </span><span class="hl-7">return</span><span class="hl-1"> </span><span class="hl-0">true</span><span class="hl-1">; </span><br/><span class="hl-1">           }</span><br/><span class="hl-1">     }</span>
</code></pre>
</div></li>
<li class="tsd-parameter">
<h5><code class="tsd-tag ts-flagOptional">Optional</code> before<wbr/>Apply<wbr/>Changes<span class="tsd-signature-symbol">?: </span><span class="tsd-signature-symbol">(</span><span class="tsd-signature-symbol">(</span>formFiller<span class="tsd-signature-symbol">: </span><span class="tsd-signature-type">any</span><span class="tsd-signature-symbol">)</span><span class="tsd-signature-symbol"> =&gt; </span><span class="tsd-signature-type">boolean</span><span class="tsd-signature-symbol">)</span></h5>
<ul class="tsd-parameters">
<li class="tsd-parameter-signature">
<ul class="tsd-signatures tsd-kind-type-literal tsd-parent-kind-type-literal">
<li class="tsd-signature" id="__type.__type-1.__type-2"><span class="tsd-signature-symbol">(</span>formFiller<span class="tsd-signature-symbol">: </span><span class="tsd-signature-type">any</span><span class="tsd-signature-symbol">)</span><span class="tsd-signature-symbol">: </span><span class="tsd-signature-type">boolean</span></li>
<li class="tsd-description">
<div class="tsd-comment tsd-typography"><p>The beforeApplyChanges event handler will be called when the Apply button is clicked after success fields validation.
Return false if you want to cancel apply changes.</p>

<h3>Example</h3><pre><code class="language-javascript"><span class="hl-5">// Split address value into two address fields before applying changes:</span><br/><span class="hl-0">var</span><span class="hl-1"> </span><span class="hl-2">viewer</span><span class="hl-1"> = </span><span class="hl-0">new</span><span class="hl-1"> </span><span class="hl-3">DsPdfViewer</span><span class="hl-1">(</span><span class="hl-4">&quot;#root&quot;</span><span class="hl-1">);</span><br/><span class="hl-2">viewer</span><span class="hl-1">.</span><span class="hl-2">options</span><span class="hl-1">.</span><span class="hl-2">formFiller</span><span class="hl-1"> = {</span><br/><span class="hl-1">   </span><span class="hl-3">beforeApplyChanges</span><span class="hl-2">:</span><span class="hl-1"> </span><span class="hl-0">function</span><span class="hl-1">(</span><span class="hl-2">formFiller</span><span class="hl-1">) {</span><br/><span class="hl-1">       </span><span class="hl-0">var</span><span class="hl-1"> </span><span class="hl-2">addr1</span><span class="hl-1"> = </span><span class="hl-2">formFiller</span><span class="hl-1">.</span><span class="hl-3">getFieldByName</span><span class="hl-1">(</span><span class="hl-4">&#39;Addr1&#39;</span><span class="hl-1">);</span><br/><span class="hl-1">       </span><span class="hl-0">var</span><span class="hl-1"> </span><span class="hl-2">addr2</span><span class="hl-1"> = </span><span class="hl-2">formFiller</span><span class="hl-1">.</span><span class="hl-3">getFieldByName</span><span class="hl-1">(</span><span class="hl-4">&#39;Addr2&#39;</span><span class="hl-1">);</span><br/><span class="hl-1">       </span><span class="hl-7">if</span><span class="hl-1">(</span><span class="hl-2">addr1</span><span class="hl-1"> &amp;&amp; </span><span class="hl-2">addr2</span><span class="hl-1">) {</span><br/><span class="hl-1">           </span><span class="hl-0">var</span><span class="hl-1"> </span><span class="hl-2">s</span><span class="hl-1"> = </span><span class="hl-2">addr1</span><span class="hl-1">.</span><span class="hl-2">fieldValue</span><span class="hl-1">;</span><br/><span class="hl-1">           </span><span class="hl-0">var</span><span class="hl-1"> </span><span class="hl-2">nlInd</span><span class="hl-1"> = </span><span class="hl-2">s</span><span class="hl-1">.</span><span class="hl-3">indexOf</span><span class="hl-1">(</span><span class="hl-4">&#39;</span><span class="hl-11">\n</span><span class="hl-4">&#39;</span><span class="hl-1">);</span><br/><span class="hl-1">           </span><span class="hl-7">if</span><span class="hl-1">(</span><span class="hl-2">nlInd</span><span class="hl-1"> !== -</span><span class="hl-8">1</span><span class="hl-1">) {</span><br/><span class="hl-1">               </span><span class="hl-0">var</span><span class="hl-1"> </span><span class="hl-2">firstPart</span><span class="hl-1"> = </span><span class="hl-2">s</span><span class="hl-1">.</span><span class="hl-3">substring</span><span class="hl-1">(</span><span class="hl-8">0</span><span class="hl-1">, </span><span class="hl-2">nlInd</span><span class="hl-1">).</span><span class="hl-3">replace</span><span class="hl-1">(</span><span class="hl-12">/\n</span><span class="hl-13">+</span><span class="hl-12">/</span><span class="hl-0">g</span><span class="hl-1">, </span><span class="hl-4">&#39; &#39;</span><span class="hl-1">);</span><br/><span class="hl-1">               </span><span class="hl-0">var</span><span class="hl-1"> </span><span class="hl-2">secondPart</span><span class="hl-1"> = </span><span class="hl-2">s</span><span class="hl-1">.</span><span class="hl-3">substr</span><span class="hl-1">(</span><span class="hl-2">nlInd</span><span class="hl-1">).</span><span class="hl-3">replace</span><span class="hl-1">(</span><span class="hl-12">/\n</span><span class="hl-13">+</span><span class="hl-12">/</span><span class="hl-0">g</span><span class="hl-1">, </span><span class="hl-4">&#39; &#39;</span><span class="hl-1">);</span><br/><span class="hl-1">               </span><span class="hl-2">addr1</span><span class="hl-1">.</span><span class="hl-2">fieldValue</span><span class="hl-1"> = </span><span class="hl-2">firstPart</span><span class="hl-1">;</span><br/><span class="hl-1">               </span><span class="hl-2">addr2</span><span class="hl-1">.</span><span class="hl-2">fieldValue</span><span class="hl-1"> = </span><span class="hl-2">secondPart</span><span class="hl-1">;</span><br/><span class="hl-1">           } </span><span class="hl-7">else</span><span class="hl-1"> {</span><br/><span class="hl-1">               </span><span class="hl-2">addr2</span><span class="hl-1">.</span><span class="hl-2">fieldValue</span><span class="hl-1"> = </span><span class="hl-4">&#39;&#39;</span><span class="hl-1">;</span><br/><span class="hl-1">           }</span><br/><span class="hl-1">           </span><span class="hl-2">formFiller</span><span class="hl-1">.</span><span class="hl-3">onFieldChanged</span><span class="hl-1">(</span><span class="hl-2">addr1</span><span class="hl-1">);</span><br/><span class="hl-1">           </span><span class="hl-2">formFiller</span><span class="hl-1">.</span><span class="hl-3">onFieldChanged</span><span class="hl-1">(</span><span class="hl-2">addr2</span><span class="hl-1">);</span><br/><span class="hl-1">       }</span><br/><span class="hl-1">       </span><span class="hl-7">return</span><span class="hl-1"> </span><span class="hl-0">true</span><span class="hl-1">;</span><br/><span class="hl-1">   },</span><br/><span class="hl-1">};</span>
</code></pre>
</div>
...
<li>
<h5>formFiller: <span class="tsd-signature-type">any</span></h5></li></ul></div>
<h4 class="tsd-returns-title">Returns <span class="tsd-signature-type">boolean</span></h4></li></ul></li></ul></li>
<li class="tsd-parameter">
<h5><code class="tsd-tag ts-flagOptional">Optional</code> before<wbr/>Field<wbr/>Change<span class="tsd-signature-symbol">?: </span><span class="tsd-signature-symbol">(</span><span class="tsd-signature-symbol">(</span>field<span class="tsd-signature-symbol">: </span><a href="../classes/WidgetAnnotation.html" class="tsd-signature-type" data-tsd-kind="Class">WidgetAnnotation</a>, formFiller<span class="tsd-signature-symbol">: </span><span class="tsd-signature-type">any</span><span class="tsd-signature-symbol">)</span><span class="tsd-signature-symbol"> =&gt; </span><span class="tsd-signature-type">boolean</span><span class="tsd-signature-symbol">)</span></h5>
<ul class="tsd-parameters">
<li class="tsd-parameter-signature">
<ul class="tsd-signatures tsd-kind-type-literal tsd-parent-kind-type-literal">
<li class="tsd-signature" id="__type.__type-3.__type-4"><span class="tsd-signature-symbol">(</span>field<span class="tsd-signature-symbol">: </span><a href="../classes/WidgetAnnotation.html" class="tsd-signature-type" data-tsd-kind="Class">WidgetAnnotation</a>, formFiller<span class="tsd-signature-symbol">: </span><span class="tsd-signature-type">any</span><span class="tsd-signature-symbol">)</span><span class="tsd-signature-symbol">: </span><span class="tsd-signature-type">boolean</span></li>
<li class="tsd-description">
<div class="tsd-comment tsd-typography"><p>The beforeFieldChange event handler will be called right before the field value changed.
Return false if you want to cancel the field value change.</p>
</div>
<div class="tsd-parameters">
<h4 class="tsd-parameters-title">Parameters</h4>
<ul class="tsd-parameter-list">
<li>
<h5>field: <a href="../classes/WidgetAnnotation.html" class="tsd-signature-type" data-tsd-kind="Class">WidgetAnnotation</a></h5></li>
<li>
<h5>formFiller: <span class="tsd-signature-type">any</span></h5></li></ul></div>
<h4 class="tsd-returns-title">Returns <span class="tsd-signature-type">boolean</span></h4></li></ul></li></ul></li>
<li class="tsd-parameter">
<h5><code class="tsd-tag ts-flagOptional">Optional</code> layout<span class="tsd-signature-symbol">?: </span><span class="tsd-signature-type">&quot;Auto&quot;</span><span class="tsd-signature-symbol"> | </span><span class="tsd-signature-type">&quot;OneColumn&quot;</span><span class="tsd-signature-symbol"> | </span><span class="tsd-signature-type">&quot;TwoColumns&quot;</span></h5>
<div class="tsd-comment tsd-typography"><p>Form Filler dialog layout type.</p>

<h3>Default</h3><p>The default is &#39;Auto&#39; - layout will switch to &#39;OneColumn&#39; for a small device screen.</p>

<h3>Example</h3><pre><code class="language-javascript"><span class="hl-1">     </span><span class="hl-2">options</span><span class="hl-1">.</span><span class="hl-2">formFiller</span><span class="hl-1"> = {</span><br/><span class="hl-1">           </span><span class="hl-2">layout:</span><span class="hl-1"> </span><span class="hl-4">&#39;OneColumn&#39;</span><br/><span class="hl-1">     }</span>
</code></pre>
</div></li>
<li class="tsd-parameter">
<h5>mappings<span class="tsd-signature-symbol">: </span><span class="tsd-signature-symbol">{ </span>[fieldName: <span class="tsd-signature-type">string</span>]<span class="tsd-signature-symbol">: </span><a href="FormFieldMapping.html" class="tsd-signature-type" data-tsd-kind="Type alias">FormFieldMapping</a><span class="tsd-signature-symbol"> }</span></h5>
<div class="tsd-comment tsd-typography"><p>Form fields mappings, 
key - field name, 
value - <a href="FormFieldMapping.html">FormFieldMapping</a>.</p>
</div>
<ul class="tsd-parameters">
<li class="tsd-parameter-index-signature">
<h5><span class="tsd-signature-symbol">[</span>fieldName: <span class="tsd-signature-type">string</span><span class="tsd-signature-symbol">]: </span><a href="FormFieldMapping.html" class="tsd-signature-type" data-tsd-kind="Type alias">FormFieldMapping</a></h5></li></ul></li>
<li class="tsd-parameter">
<h5><code class="tsd-tag ts-flagOptional">Optional</code> on<wbr/>Initialize<span class="tsd-signature-symbol">?: </span><span class="tsd-signature-symbol">(</span><span class="tsd-signature-symbol">(</span>formFiller<span class="tsd-signature-symbol">: </span><span class="tsd-signature-type">any</span><span class="tsd-signature-symbol">)</span><span class="tsd-signature-symbol"> =&gt; </span><span class="tsd-signature-type">void</span><span class="tsd-signature-symbol">)</span></h5>
<ul class="tsd-parameters">
<li class="tsd-parameter-signature">
<ul class="tsd-signatures tsd-kind-type-literal tsd-parent-kind-type-literal">
<li class="tsd-signature" id="__type.__type-6.__type-7"><span class="tsd-signature-symbol">(</span>formFiller<span class="tsd-signature-symbol">: </span><span class="tsd-signature-type">any</span><span class="tsd-signature-symbol">)</span><span class="tsd-signature-symbol">: </span><span class="tsd-signature-type">void</span></li>
<li class="tsd-description">
<div class="tsd-comment tsd-typography"><p>The onInitialize event handler is called after the list of fields is loaded and initialized but not yet rendered.</p>

<h3>Example</h3><pre><code class="language-javascript"><span class="hl-2">options</span><span class="hl-1">.</span><span class="hl-2">formFiller</span><span class="hl-1"> = {</span><br/><span class="hl-1">   </span><span class="hl-5">// Combine two address fields into one after loading fields</span><br/><span class="hl-1">   </span><span class="hl-3">onInitialize</span><span class="hl-2">:</span><span class="hl-1"> </span><span class="hl-0">function</span><span class="hl-1">(</span><span class="hl-2">formFiller</span><span class="hl-1">) {</span><br/><span class="hl-1">       </span><span class="hl-0">var</span><span class="hl-1"> </span><span class="hl-2">addr1</span><span class="hl-1"> = </span><span class="hl-2">formFiller</span><span class="hl-1">.</span><span class="hl-3">getFieldByName</span><span class="hl-1">(</span><span class="hl-4">&#39;Addr1&#39;</span><span class="hl-1">);</span><br/><span class="hl-1">       </span><span class="hl-0">var</span><span class="hl-1"> </span><span class="hl-2">addr2</span><span class="hl-1"> = </span><span class="hl-2">formFiller</span><span class="hl-1">.</span><span class="hl-3">getFieldByName</span><span class="hl-1">(</span><span class="hl-4">&#39;Addr2&#39;</span><span class="hl-1">);</span><br/><span class="hl-1">       </span><span class="hl-7">if</span><span class="hl-1">(</span><span class="hl-2">addr1</span><span class="hl-1"> &amp;&amp; </span><span class="hl-2">addr2</span><span class="hl-1">) {</span><br/><span class="hl-1">           </span><span class="hl-7">if</span><span class="hl-1">(</span><span class="hl-2">addr2</span><span class="hl-1">.</span><span class="hl-2">fieldValue</span><span class="hl-1">) {</span><br/><span class="hl-1">               </span><span class="hl-2">addr1</span><span class="hl-1">.</span><span class="hl-2">fieldValue</span><span class="hl-1"> = </span><span class="hl-2">addr1</span><span class="hl-1">.</span><span class="hl-2">fieldValue</span><span class="hl-1"> + </span><span class="hl-4">&#39;</span><span class="hl-11">\n</span><span class="hl-4">&#39;</span><span class="hl-1"> + </span><span class="hl-2">addr2</span><span class="hl-1">.</span><span class="hl-2">fieldValue</span><span class="hl-1">;</span><br/><span class="hl-1">               </span><span class="hl-2">addr2</span><span class="hl-1">.</span><span class="hl-2">fieldValue</span><span class="hl-1"> = </span><span class="hl-4">&#39;&#39;</span><span class="hl-1">;</span><br/><span class="hl-1">               </span><span class="hl-2">formFiller</span><span class="hl-1">.</span><span class="hl-3">onFieldChanged</span><span class="hl-1">(</span><span class="hl-2">addr1</span><span class="hl-1">);</span><br/><span class="hl-1">               </span><span class="hl-2">formFiller</span><span class="hl-1">.</span><span class="hl-3">onFieldChanged</span><span class="hl-1">(</span><span class="hl-2">addr2</span><span class="hl-1">);</span><br/><span class="hl-1">           }</span><br/><span class="hl-1">       }</span><br/><span class="hl-1">   }</span><br/><span class="hl-1">}</span>
</code></pre>
</div>
<div class="tsd-parameters">
<h4 class="tsd-parameters-title">Parameters</h4>
...
<h3>Default</h3><p>&#39;Form Filler&#39;</p>

<h3>Example</h3><pre><code class="language-javascript"><span class="hl-1">      </span><span class="hl-2">options</span><span class="hl-1">.</span><span class="hl-2">formFiller</span><span class="hl-1"> = {</span><br/><span class="hl-1">            </span><span class="hl-2">title:</span><span class="hl-1"> </span><span class="hl-4">&#39;Please fill the form&#39;</span><br/><span class="hl-1">      };</span>
</code></pre>
</div></li>
<li class="tsd-parameter">
<h5><code class="tsd-tag ts-flagOptional">Optional</code> validator<span class="tsd-signature-symbol">?: </span><span class="tsd-signature-symbol">(</span><span class="tsd-signature-symbol">(</span>fieldValue<span class="tsd-signature-symbol">: </span><span class="tsd-signature-type">string</span><span class="tsd-signature-symbol"> | </span><span class="tsd-signature-type">string</span><span class="tsd-signature-symbol">[]</span>, field<span class="tsd-signature-symbol">: </span><a href="../classes/WidgetAnnotation.html" class="tsd-signature-type" data-tsd-kind="Class">WidgetAnnotation</a>, args<span class="tsd-signature-symbol">: </span><span class="tsd-signature-symbol">{ </span>caller<span class="tsd-signature-symbol">: </span><span class="tsd-signature-type">ValidationCallerType</span><span class="tsd-signature-symbol"> }</span><span class="tsd-signature-symbol">)</span><span class="tsd-signature-symbol"> =&gt; </span><span class="tsd-signature-type">boolean</span><span class="tsd-signature-symbol"> | </span><span class="tsd-signature-type">string</span><span class="tsd-signature-symbol">)</span></h5>
<ul class="tsd-parameters">
<li class="tsd-parameter-signature">
<ul class="tsd-signatures tsd-kind-type-literal tsd-parent-kind-type-literal">
<li class="tsd-signature" id="__type.__type-8.__type-9"><span class="tsd-signature-symbol">(</span>fieldValue<span class="tsd-signature-symbol">: </span><span class="tsd-signature-type">string</span><span class="tsd-signature-symbol"> | </span><span class="tsd-signature-type">string</span><span class="tsd-signature-symbol">[]</span>, field<span class="tsd-signature-symbol">: </span><a href="../classes/WidgetAnnotation.html" class="tsd-signature-type" data-tsd-kind="Class">WidgetAnnotation</a>, args<span class="tsd-signature-symbol">: </span><span class="tsd-signature-symbol">{ </span>caller<span class="tsd-signature-symbol">: </span><span class="tsd-signature-type">ValidationCallerType</span><span class="tsd-signature-symbol"> }</span><span class="tsd-signature-symbol">)</span><span class="tsd-signature-symbol">: </span><span class="tsd-signature-type">boolean</span><span class="tsd-signature-symbol"> | </span><span class="tsd-signature-type">string</span></li>
<li class="tsd-description">
<div class="tsd-comment tsd-typography"><p>The validator function which will be called for each field before saving changes
...
<h5>field: <a href="../classes/WidgetAnnotation.html" class="tsd-signature-type" data-tsd-kind="Class">WidgetAnnotation</a></h5></li>
<li>
<h5>args: <span class="tsd-signature-symbol">{ </span>caller<span class="tsd-signature-symbol">: </span><span class="tsd-signature-type">ValidationCallerType</span><span class="tsd-signature-symbol"> }</span></h5>
<ul class="tsd-parameters">
<li class="tsd-parameter">
<h5>caller<span class="tsd-signature-symbol">: </span><span class="tsd-signature-type">ValidationCallerType</span></h5></li></ul></li></ul></div>
<h4 class="tsd-returns-title">Returns <span class="tsd-signature-type">boolean</span><span class="tsd-signature-symbol"> | </span><span class="tsd-signature-type">string</span></h4></li></ul></li></ul></li></ul></div></div>
...
<li class="current tsd-kind-type-alias"><a href="FormFillerSettings.html" class="tsd-index-link"><svg class="tsd-kind-icon" width="24" height="24" viewBox="0 0 24 24"><use href="#icon-4194304-path"></use><use href="#icon-4194304-text"></use></svg>Form<wbr/>Filler<wbr/>Settings</a></li>
