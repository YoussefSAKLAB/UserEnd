<!DOCTYPE html><html class="default" lang="en"><head><meta charSet="utf-8"/><meta http-equiv="x-ua-compatible" content="IE=edge"/><title>SignatureInfo | Document Solutions PDF Viewer - v7.0.3</title><meta name="description" content="Documentation for Document Solutions PDF Viewer - v7.0.3"/><meta name="viewport" content="width=device-width, initial-scale=1"/><link rel="stylesheet" href="../assets/style.css"/><link rel="stylesheet" href="../assets/highlight.css"/><link rel="stylesheet" href="../assets/custom.css"/><script async src="../assets/search.js" id="search-script"></script></head><body><script>document.documentElement.dataset.theme = localStorage.getItem("tsd-theme") || "os"</script><header class="tsd-page-toolbar">
...
<li><a href="SignatureInfo.html">SignatureInfo</a></li></ul>
<h1>Type alias SignatureInfo</h1></div>
<div class="tsd-signature">Signature<wbr/>Info<span class="tsd-signature-symbol">:</span> <span class="tsd-signature-symbol">{ </span>contactInfo<span class="tsd-signature-symbol">: </span><span class="tsd-signature-type">string</span><span class="tsd-signature-symbol">; </span>location<span class="tsd-signature-symbol">: </span><span class="tsd-signature-type">string</span><span class="tsd-signature-symbol">; </span>reason<span class="tsd-signature-symbol">: </span><span class="tsd-signature-type">string</span><span class="tsd-signature-symbol">; </span>signatureField<span class="tsd-signature-symbol">: </span><span class="tsd-signature-type">string</span><span class="tsd-signature-symbol">; </span>signerName<span class="tsd-signature-symbol">: </span><span class="tsd-signature-type">string</span><span class="tsd-signature-symbol"> }</span></div>
<div class="tsd-comment tsd-typography"><p>Information about the document signature that will be used to sign the document.</p>

<h3>Example</h3><p>Send a request to the server to save the document with signature.</p>
<pre><code class="language-javascript"><span class="hl-2">viewer</span><span class="hl-1">.</span><span class="hl-3">save</span><span class="hl-1">(</span><span class="hl-4">&quot;test.pdf&quot;</span><span class="hl-1">, { </span><span class="hl-2">sign:</span><span class="hl-1"> { </span><span class="hl-2">signatureField:</span><span class="hl-1"> </span><span class="hl-4">&quot;field1&quot;</span><span class="hl-1">, </span><span class="hl-2">signerName:</span><span class="hl-1"> </span><span class="hl-4">&quot;John Doe&quot;</span><span class="hl-1"> } } );</span>
</code></pre>

<h3>Example</h3><p>Example of server side signing implementation</p>
<pre><code class="language-csharp"><span class="hl-5">// Example: electronically sign PDFs with a .PFX certificate:</span><br/><br/><span class="hl-0">public</span><span class="hl-1"> </span><span class="hl-0">void</span><span class="hl-1"> </span><span class="hl-3">Configuration</span><span class="hl-1">(</span><span class="hl-9">IAppBuilder</span><span class="hl-1"> </span><span class="hl-2">app</span><span class="hl-1">) {</span><br/><span class="hl-1">    </span><span class="hl-2">GcPdfViewerController</span><span class="hl-1">.</span><span class="hl-2">Settings</span><span class="hl-1">.</span><span class="hl-2">Sign</span><span class="hl-1"> += </span><span class="hl-2">_OnSign</span><span class="hl-1">;</span><br/><span class="hl-1">    </span><span class="hl-5">// ... </span><br/><span class="hl-1">}</span><br/><br/><span class="hl-0">private</span><span class="hl-1"> </span><span class="hl-0">void</span><span class="hl-1"> </span><span class="hl-3">_OnSign</span><span class="hl-1">(</span><span class="hl-0">object</span><span class="hl-1"> </span><span class="hl-2">sender</span><span class="hl-1">, </span><span class="hl-9">SignEventArgs</span><span class="hl-1"> </span><span class="hl-2">e</span><span class="hl-1">)</span><br/><span class="hl-1">{</span><br/><span class="hl-1">    </span><span class="hl-0">var</span><span class="hl-1"> </span><span class="hl-2">signatureProperties</span><span class="hl-1"> = </span><span class="hl-2">e</span><span class="hl-1">.</span><span class="hl-2">SignatureProperties</span><span class="hl-1">;</span><br/><span class="hl-1">    </span><span class="hl-9">X509Certificate2</span><span class="hl-1"> </span><span class="hl-2">certificate</span><span class="hl-1"> = </span><span class="hl-0">new</span><span class="hl-1"> </span><span class="hl-9">X509Certificate2</span><span class="hl-1">(</span><span class="hl-2">System</span><span class="hl-1">.</span><span class="hl-2">IO</span><span class="hl-1">.</span><span class="hl-2">File</span><span class="hl-1">.</span><span class="hl-3">ReadAllBytes</span><span class="hl-1">(</span><span class="hl-4">&quot;certificate.pfx&quot;</span><span class="hl-1">), </span><span class="hl-4">&quot;password&quot;</span><span class="hl-1">, </span><br/><span class="hl-1">      </span><span class="hl-2">X509KeyStorageFlags</span><span class="hl-1">.</span><span class="hl-2">MachineKeySet</span><span class="hl-1"> | </span><span class="hl-2">X509KeyStorageFlags</span><span class="hl-1">.</span><span class="hl-2">PersistKeySet</span><span class="hl-1"> | </span><span class="hl-2">X509KeyStorageFlags</span><span class="hl-1">.</span><span class="hl-2">Exportable</span><span class="hl-1">);</span><br/><span class="hl-1">    </span><span class="hl-2">signatureProperties</span><span class="hl-1">.</span><span class="hl-2">SignatureBuilder</span><span class="hl-1"> = </span><span class="hl-0">new</span><span class="hl-1"> </span><span class="hl-9">Pkcs7SignatureBuilder</span><span class="hl-1">()</span><br/><span class="hl-1">    {</span><br/><span class="hl-1">       </span><span class="hl-2">CertificateChain</span><span class="hl-1"> = </span><span class="hl-0">new</span><span class="hl-1"> </span><span class="hl-9">X509Certificate2</span><span class="hl-1">[] { </span><span class="hl-2">certificate</span><span class="hl-1"> },</span><br/><span class="hl-1">       </span><span class="hl-2">HashAlgorithm</span><span class="hl-1"> = </span><span class="hl-2">Security</span><span class="hl-1">.</span><span class="hl-2">OID</span><span class="hl-1">.</span><span class="hl-2">HashAlgorithms</span><span class="hl-1">.</span><span class="hl-2">SHA512</span><span class="hl-1">,</span><br/><span class="hl-1">       </span><span class="hl-2">Format</span><span class="hl-1"> = </span><span class="hl-2">Pkcs7SignatureBuilder</span><span class="hl-1">.</span><span class="hl-2">SignatureFormat</span><span class="hl-1">.</span><span class="hl-2">adbe_pkcs7_detached</span><br/><span class="hl-1">    };</span><br/><span class="hl-1">}</span>
</code></pre>
</div>
...
<h5>contact<wbr/>Info<span class="tsd-signature-symbol">: </span><span class="tsd-signature-type">string</span></h5>
<div class="tsd-comment tsd-typography"><p>The information provided by the signer to enable a recipient to contact the signer to verify the signature (for example, a phone number).</p>
</div></li>
<li class="tsd-parameter">
<h5>location<span class="tsd-signature-symbol">: </span><span class="tsd-signature-type">string</span></h5>
<div class="tsd-comment tsd-typography"><p>The CPU host name or physical location of the signing.</p>
</div></li>
<li class="tsd-parameter">
<h5>reason<span class="tsd-signature-symbol">: </span><span class="tsd-signature-type">string</span></h5>
<div class="tsd-comment tsd-typography"><p>The reason for the signing, such as &quot;I agree...&quot;.</p>
</div></li>
<li class="tsd-parameter">
<h5>signature<wbr/>Field<span class="tsd-signature-symbol">: </span><span class="tsd-signature-type">string</span></h5>
<div class="tsd-comment tsd-typography"><p>The signature field name used to store a digital signature.</p>
</div></li>
<li class="tsd-parameter">
<h5>signer<wbr/>Name<span class="tsd-signature-symbol">: </span><span class="tsd-signature-type">string</span></h5>
<div class="tsd-comment tsd-typography"><p>The name of the person or authority signing the document. 
NOTE: This value is used only if it is not possible to extract the name from the signature, for example from the certificate of the signer.</p>
</div></li></ul></div></div>
...
<li class="current tsd-kind-type-alias"><a href="SignatureInfo.html" class="tsd-index-link"><svg class="tsd-kind-icon" width="24" height="24" viewBox="0 0 24 24"><use href="#icon-4194304-path"></use><use href="#icon-4194304-text"></use></svg>Signature<wbr/>Info</a></li>
